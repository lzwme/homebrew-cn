...
# https://ghproxy.com/github.com/Homebrew/brew/blob/master/Library/Homebrew/keg.rb
directories=(
...
echo "$(
  cat <<EOS
  ${tty_underline}https://ghproxy.com/github.com/Homebrew/brew#donations${tty_reset}
EOS
)
"

class Swift < Formula
  ...
  url "https://ghproxy.com/https://github.com/apple/swift/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
  ...
  on_linux do
    ...
    resource "swift-corelibs-foundation" do
      url "https://ghproxy.com/https://github.com/apple/swift-corelibs-foundation/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
      sha256 "78852bcfcf703957953761cbd18a2398c31b25f26ddf3ac18983b959e1564f3d"
    end

    resource "swift-corelibs-libdispatch" do
      url "https://ghproxy.com/https://github.com/apple/swift-corelibs-libdispatch/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    ...
    resource "swift-corelibs-xctest" do
      url "https://ghproxy.com/https://github.com/apple/swift-corelibs-xctest/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
  ...
  resource "llvm-project" do
    url "https://ghproxy.com/https://github.com/apple/llvm-project/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "003e933dcfe8251ab0d809aba36d8f38d3cafa5946df2e0f0713962d9e5ebd62"
  end

  resource "cmark" do
    url "https://ghproxy.com/https://github.com/apple/swift-cmark/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "143a58286e611460ba5ffe3d53d8be5bfbe655f9eba4571201537bb417547b63"
  end

  resource "llbuild" do
    url "https://ghproxy.com/https://github.com/apple/swift-llbuild/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "bf1f1ca43d4f658813382ddb144d11f2ccd79ab7b10b31fde673087587310909"
  end

  resource "swiftpm" do
    url "https://ghproxy.com/https://github.com/apple/swift-package-manager/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "01ed764386cbac24c07497b192261746ddc961ce876f5f94bdcebccc1322105c"
  end

  resource "indexstore-db" do
    url "https://ghproxy.com/https://github.com/apple/indexstore-db/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "210eff2343c4b122fd8622af7f0ad19cca41838dac66db8b5a35d477eaae79a0"
  end

  resource "sourcekit-lsp" do
    url "https://ghproxy.com/https://github.com/apple/sourcekit-lsp/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "cabcc7b5b839fff159210a04303660646ba2d1f51c9cf288c3a6df3373cbcd96"
  end

  resource "swift-driver" do
    url "https://ghproxy.com/https://github.com/apple/swift-driver/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "4a730616abd89191dfbebae888bc9c2436447868b69b2d4dcb7dbb2111ad2863"
  end

  resource "swift-tools-support-core" do
    url "https://ghproxy.com/https://github.com/apple/swift-tools-support-core/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "a0c54390f93642ee5df61bc65274c8c6a11e35177fb20188c1d9b710d69ef319"
  end

  resource "swift-docc" do
    url "https://ghproxy.com/https://github.com/apple/swift-docc/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "bd0a4e652ca15b626a30b05e6931945267c3b15a0504628a102fcc97ebed45dd"
  end

  resource "swift-lmdb" do
    url "https://ghproxy.com/https://github.com/apple/swift-lmdb/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "915c99c1b4e4031db076e3c357dedb52df350c7c968c8b77f6ad5753b11a2ff3"
  end

  resource "swift-docc-render-artifact" do
    url "https://ghproxy.com/https://github.com/apple/swift-docc-render-artifact/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "7ae5fbce5e860d94514c91f28228fb762297de2be1e01233e4046174fdfc16be"
  end

  resource "swift-docc-symbolkit" do
    url "https://ghproxy.com/https://github.com/apple/swift-docc-symbolkit/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "8a2e44c5eae188cf697785ceace4be96dceea46d47c32cb9e0728786ce72ef57"
  end

  resource "swift-markdown" do
    url "https://ghproxy.com/https://github.com/apple/swift-markdown/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
    sha256 "d2d14a2879d43c0579eb6e0562cb408596985862117441acf834cafa7d7f4f63"
  end

  resource "swift-cmark-gfm" do
    url "https://ghproxy.com/https://github.com/apple/swift-cmark/archive/refs/tags/swift-5.7.3-RELEASE-gfm.tar.gz"
    sha256 "2dbcd0fb1907b5feb321175d9a3e629dc2845a7bde7ad9e5846b3074e3d93768"
  end

  resource "swift-experimental-string-processing" do
    url "https://ghproxy.com/https://github.com/apple/swift-experimental-string-processing/archive/refs/tags/swift-5.7.3-RELEASE.tar.gz"
  ...
  resource "swift-crypto" do
    url "https://ghproxy.com/https://github.com/apple/swift-crypto/archive/refs/tags/1.1.5.tar.gz"
  ...
  # As above: refer to update-checkout-config.json
  resource "yams" do
    url "https://ghproxy.com/https://github.com/jpsim/Yams/archive/refs/tags/5.0.0.tar.gz"

class PhpAT73DebugZts < Formula
  ...
  url "https:github.comshivammathurphp-src-backportsarchivee1ccf67c96d54e0f1db4ac5fc6b8c2134e48f199.tar.gz"
  version "7.3.33"
  ...
  patch do
    url "https:github.comphpphp-srccommit69190ce5c053a9bf97983932bd702137895b18df.patch?full_index=1"
  ...
  def install
    ...
    # php 7.3 known bug
    # SO discussion: https:stackoverflow.coma53709484791609
    # bug report: https:bugs.php.netbug.php?id=77260
  ...
  def post_install
    ...
    pear_path = HOMEBREW_PREFIX"sharepear@#{version.major_minor}-debug-zts"
    cp_r pkgshare"pear.", pear_path
    {
      "php_ini"  => etc"php#{version.major_minor}-debug-ztsphp.ini",
      "php_dir"  => pear_path,
    ...
    %w[
      ...
      ext_config_path = etc"php#{version.major_minor}-debug-ztsconf.dext-#{e}.ini"

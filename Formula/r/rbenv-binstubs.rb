class RbenvBinstubs < Formula
  ...
  homepage "https:github.comianheggierbenv-binstubs"
  url "https:github.comianheggierbenv-binstubsarchiverefstagsv1.5.tar.gz"
  sha256 "305000b8ba5b829df1a98fc834b7868b9e817815c661f429b0e28c1f613f4d0c"
  license "MIT"
  revision 1
  head "https:github.comianheggierbenv-binstubs.git", branch: "master"

class Reckoner < Formula
  ...
  homepage "https:github.comFairwindsOpsreckoner"
  url "https:github.comFairwindsOpsreckonerarchiverefstagsv6.1.0.tar.gz"
  sha256 "499d31ca10e1ab0e09a8ede5a8bf9adeab88d8d081f57ee30b1cc3f0864735b7"
  license "Apache-2.0"
  head "https:github.comFairwindsOpsreckoner.git", branch: "master"

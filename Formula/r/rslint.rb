class Rslint < Formula
  ...
  url "https:github.comrslintrslintarchiverefstagsv0.3.2.tar.gz"
  ...
  def install
    system "cargo", "install", *std_cargo_args(path: "cratesrslint_cli")
  end

  test do
    # https:rslint.orgruleserrorsno-empty.html#invalid-code-examples

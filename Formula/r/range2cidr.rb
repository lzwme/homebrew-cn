class Range2cidr < Formula
  ...
  url "https:github.comipinfocliarchiverefstagsrange2cidr-1.3.0.tar.gz"
  ...
  test do
    ...
    assert_equal "1.1.1.030", shell_output("#{bin}range2cidr 1.1.1.0-1.1.1.3").chomp
    assert_equal "0.0.0.00", shell_output("#{bin}range2cidr 0.0.0.0-255.255.255.255").chomp
    assert_equal "1.1.1.031\n1.1.1.232", shell_output("#{bin}range2cidr 1.1.1.0-1.1.1.2").chomp
  end
end
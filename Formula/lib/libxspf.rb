class Libxspf < Formula
  ...
  url "https:downloads.sourceforge.netprojectlibspiffSources1.2.1libxspf-1.2.1.tar.bz2"
  ...
  resource "check.cpp" do
    url "https:gitlab.xiph.orgxiphlibxspf-rawmasterexamplescheckcheck.cpp"

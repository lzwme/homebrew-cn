class Libstatgrab < Formula
  ...
  url "https:github.comlibstatgrablibstatgrabreleasesdownloadLIBSTATGRAB_0_92_1libstatgrab-0.92.1.tar.gz"
  mirror "https:www.mirrorservice.orgpubi-screamlibstatgrablibstatgrab-0.92.1.tar.gz"

class Libcdio < Formula
  ...
  homepage "https:www.gnu.orgsoftwarelibcdio"
  url "https:ftp.gnu.orggnulibcdiolibcdio-2.1.0.tar.bz2"
  mirror "https:ftpmirror.gnu.orglibcdiolibcdio-2.1.0.tar.bz2"

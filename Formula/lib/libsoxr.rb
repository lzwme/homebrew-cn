class Libsoxr < Formula
  ...
  homepage "https:sourceforge.netprojectssoxr"
  url "https:downloads.sourceforge.netprojectsoxrsoxr-0.1.3-Source.tar.xz"
  ...
  # Upstream pull request: https:sourceforge.netpsoxrcodemerge-requests5
  patch do
    url "https:raw.githubusercontent.comHomebrewformula-patches76868b36263be42440501d3692fd3a258f507d82libsoxrarm64_defines.patch"

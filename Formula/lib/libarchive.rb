class Libarchive < Formula
  ...
  url "https:www.libarchive.orgdownloadslibarchive-3.7.9.tar.xz"
  ...
  def install
    ...
    inreplace lib"pkgconfiglibarchive.pc", prefix.to_s, opt_prefix.to_s

    return unless OS.mac?

    # fixes https:github.comlibarchivelibarchiveissues1819
    inreplace lib"pkgconfiglibarchive.pc" do |s|

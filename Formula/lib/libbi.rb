class Libbi < Formula
  ...
  resource "Parse::Template" do
    url "https:cpan.metacpan.orgauthorsidPPSPSCUSTParseTemplate-3.08.tar.gz"
    sha256 "3c7734f53999de8351a77cb09631d7a4a0482b6f54bca63d69d5a4eec8686d51"
  end

  resource "Parse::Lex" do
    url "https:cpan.metacpan.orgauthorsidPPSPSCUSTParseLex-2.21.tar.gz"
  ...
  resource "Math::Symbolic" do
    url "https:cpan.metacpan.orgauthorsidSSMSMUELLERMath-Symbolic-0.612.tar.gz"
  ...
  resource "File::Remove" do
    url "https:cpan.metacpan.orgauthorsidSSHSHLOMIFFile-Remove-1.57.tar.gz"
  ...
  resource "Class::Inspector" do
    url "https:cpan.metacpan.orgauthorsidPPLPLICEASEClass-Inspector-1.32.tar.gz"
    sha256 "cefadc8b5338e43e570bc43f583e7c98d535c17b196bcf9084bb41d561cc0535"
  end

  resource "File::ShareDir" do
    url "https:cpan.metacpan.orgauthorsidRREREHSACKFile-ShareDir-1.104.tar.gz"
    sha256 "07b628efcdf902d6a32e6a8e084497e8593d125c03ad12ef5cc03c87c7841caf"
  end

  resource "Template" do
    url "https:cpan.metacpan.orgauthorsidAABABWTemplate-Toolkit-2.27.tar.gz"
    sha256 "1311a403264d0134c585af0309ff2a9d5074b8ece23ece5660d31ec96bf2c6dc"
  end

  resource "Graph" do
    url "https:cpan.metacpan.orgauthorsidJJHJHIGraph-0.9704.tar.gz"
    sha256 "325e8eb07be2d09a909e450c13d3a42dcb2a2e96cc3ac780fe4572a0d80b2a25"
  end

  resource "thrust" do
    url "https:github.comNVIDIAthrustarchiverefstags1.8.2.tar.gz"

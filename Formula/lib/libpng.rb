class Libpng < Formula
  ...
  url "https:downloads.sourceforge.netprojectlibpnglibpng161.6.41libpng-1.6.41.tar.xz"
  mirror "https:sourceforge.mirrorservice.orgllilibpnglibpng161.6.41libpng-1.6.41.tar.xz"

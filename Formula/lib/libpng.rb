class Libpng < Formula
  ...
  url "https:downloads.sourceforge.netprojectlibpnglibpng161.6.46libpng-1.6.46.tar.xz"
  mirror "https:sourceforge.mirrorservice.orgllilibpnglibpng161.6.46libpng-1.6.46.tar.xz"

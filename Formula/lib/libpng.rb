class Libpng < Formula
  ...
  url "https:downloads.sourceforge.netprojectlibpnglibpng161.6.42libpng-1.6.42.tar.xz"
  mirror "https:sourceforge.mirrorservice.orgllilibpnglibpng161.6.42libpng-1.6.42.tar.xz"

class Libpng < Formula
  ...
  url "https:downloads.sourceforge.netprojectlibpnglibpng161.6.45libpng-1.6.45.tar.xz"
  mirror "https:sourceforge.mirrorservice.orgllilibpnglibpng161.6.45libpng-1.6.45.tar.xz"

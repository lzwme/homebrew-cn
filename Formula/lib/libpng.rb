class Libpng < Formula
  ...
  url "https:downloads.sourceforge.netprojectlibpnglibpng161.6.47libpng-1.6.47.tar.xz"
  mirror "https:sourceforge.mirrorservice.orgllilibpnglibpng161.6.47libpng-1.6.47.tar.xz"

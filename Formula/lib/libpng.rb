class Libpng < Formula
  ...
  url "https:downloads.sourceforge.netprojectlibpnglibpng161.6.43libpng-1.6.43.tar.xz"
  mirror "https:sourceforge.mirrorservice.orgllilibpnglibpng161.6.43libpng-1.6.43.tar.xz"

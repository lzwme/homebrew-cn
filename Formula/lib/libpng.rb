class Libpng < Formula
  ...
  url "https:downloads.sourceforge.netprojectlibpnglibpng161.6.44libpng-1.6.44.tar.xz"
  mirror "https:sourceforge.mirrorservice.orgllilibpnglibpng161.6.44libpng-1.6.44.tar.xz"

class Libheif < Formula
  ...
  url "https:github.comstrukturaglibheifreleasesdownloadv1.19.1libheif-1.19.1.tar.gz"
  ...
  def install
    ...
    inreplace "examplesheif_info.cc", "fourcc_to_string", "example_fourcc_to_string"

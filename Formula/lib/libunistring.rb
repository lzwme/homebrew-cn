class Libunistring < Formula
  ...
  homepage "https:www.gnu.orgsoftwarelibunistring"
  url "https:ftp.gnu.orggnulibunistringlibunistring-1.3.tar.gz"
  mirror "https:ftpmirror.gnu.orglibunistringlibunistring-1.3.tar.gz"
  mirror "http:ftp.gnu.orggnulibunistringlibunistring-1.3.tar.gz"
  ...
  def install
    ...
    # https:github.comcoreutilsgnulibcommitbab130878fe57086921fa7024d328341758ed453
    # https:savannah.gnu.orgbugs?65686

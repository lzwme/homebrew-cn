class Libxml2 < Formula
  ...
  url "https:download.gnome.orgsourceslibxml22.13libxml2-2.13.5.tar.xz"
  ...
  def install
    ...
    icu4c = deps.find { |dep| dep.name.match?(^icu4c(@\d+)?$) }
                .to_formula
    inreplace [bin"xml2-config", lib"pkgconfiglibxml-2.0.pc"], icu4c.prefix.realpath, icu4c.opt_prefix

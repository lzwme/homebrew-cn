class Libvisual < Formula
  ...
  url "https:github.comLibvisuallibvisualreleasesdownloadlibvisual-0.4.2libvisual-0.4.2.tar.gz"
  ...
  def install
    ...
    #       See libvisual-plugins.rb andor libvisual-projectm.rb
    ...
    inreplace "configure",
      ...
      "LIBVISUAL_PLUGINS_BASE_DIR=\"#{HOMEBREW_PREFIX}liblibvisual-#{version.major_minor}\""

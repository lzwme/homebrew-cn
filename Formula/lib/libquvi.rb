class Libquvi < Formula
  ...
  url "https:downloads.sourceforge.netprojectquvi0.4libquvilibquvi-0.4.1.tar.bz2"
  ...
  resource "scripts" do
    url "https:downloads.sourceforge.netprojectquvi0.4libquvi-scriptslibquvi-scripts-0.4.14.tar.xz"
  ...
  def install
    ENV.prepend_path "PKG_CONFIG_PATH", Formula["lua@5.1"].opt_libexec"libpkgconfig"
    ...
    ENV.append_path "PKG_CONFIG_PATH", "#{scripts}libpkgconfig"

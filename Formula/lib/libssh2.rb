class Libssh2 < Formula
  ...
  url "https:libssh2.orgdownloadlibssh2-1.11.1.tar.gz"
  mirror "https:github.comlibssh2libssh2releasesdownloadlibssh2-1.11.1libssh2-1.11.1.tar.gz"
  mirror "http:download.openpkg.orgcomponentscachelibssh2libssh2-1.11.1.tar.gz"
  sha256 "d9ec76cbe34db98eec3539fe2c899d26b0c837cb3eb466a56b0f109cabf658f7"
  license "BSD-3-Clause"

  livecheck do
    url "https:libssh2.orgdownload"
  ...
  head do
    url "https:github.comlibssh2libssh2.git", branch: "master"

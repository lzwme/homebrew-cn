class Libssh2 < Formula
  ...
  url "https:libssh2.orgdownloadlibssh2-1.11.0.tar.gz"
  mirror "https:github.comlibssh2libssh2releasesdownloadlibssh2-1.11.0libssh2-1.11.0.tar.gz"
  mirror "http:download.openpkg.orgcomponentscachelibssh2libssh2-1.11.0.tar.gz"

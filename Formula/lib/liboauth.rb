class Liboauth < Formula
  ...
  homepage "https:sourceforge.netprojectsliboauth"
  url "https:downloads.sourceforge.netprojectliboauthliboauth-1.0.3.tar.gz"
  ...
  patch :p0 do
    url "https:raw.githubusercontent.comfreebsdfreebsd-ports121e6c77a8e6b9532ce6e45c8dd8dbf38ca4f97dnetliboauthfilespatch-src_hash.c"

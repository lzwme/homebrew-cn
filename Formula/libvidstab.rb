class Libvidstab < Formula
  ...
  url "https://ghproxy.com/https://github.com/georgmartius/vid.stab/archive/v1.1.0.tar.gz"
  ...
  patch do
    url "https://ghproxy.com/https://raw.githubusercontent.com/Homebrew/formula-patches/5bf1a0e0cfe666ee410305cece9c9c755641bfdf/libvidstab/fix_cmake_quoting.patch"

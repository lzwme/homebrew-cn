class Npth < Formula
  ...
  url "https:gnupg.orgftpgcryptnpthnpth-1.6.tar.bz2"
  mirror "https:www.mirrorservice.orgsitesftp.gnupg.orggcryptnpthnpth-1.6.tar.bz2"
  sha256 "1393abd9adcf0762d34798dc34fdcf4d0d22a8410721e76f1e3afcd1daa4e2d1"
  license "LGPL-2.1-or-later"

  livecheck do
    url "https:gnupg.orgftpgcryptnpth"
    regex(href=.*?npth[._-]v?(\d+(?:\.\d+)+)\.ti)
  end

class Ninja < Formula
  ...
  url "https:github.comninja-buildninjaarchiverefstagsv1.11.1.tar.gz"
  ...
  patch do
    url "https:github.comninja-buildninjacommit67834978a6abdfb790dac165b8b1f1c93648e624.patch?full_index=1"

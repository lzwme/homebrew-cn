class Nanomsgxx < Formula
  ...
  homepage "https:achille-roussel.github.ionanomsgxxdocnanomsgxx.7.html"
  url "https:github.comachille-rousselnanomsgxxarchiverefstags0.2.tar.gz"
  ...
  # Add python3 support
  #
  # This patch mimics changes from https:github.comachille-rousselnanomsgxxpull26
  # but can't be applied as a formula patch since it contains GIT binary patch
  #
  # Remove this in next release
  resource "waf" do
    url "https:raw.githubusercontent.comachille-rousselnanomsgxx4426567809a79352f65bbd2d69488df237442d33waf"
    sha256 "0a09ad26a2cfc69fa26ab871cb558165b60374b5a653ff556a0c6aca63a00df1"
  end

  patch do
    url "https:github.comachille-rousselnanomsgxxcommitf5733e2e9347bae0d4d9e657ca0cf8010a9dd6d7.patch?full_index=1"
    sha256 "e6e05e5dd85b8131c936750b554a0a874206fed11b96413b05ee3f33a8a2d90f"
  end

  # Add support for newer version of waf
  patch do
    url "https:github.comachille-rousselnanomsgxxcommit08c6d8882e40d0279e58325d641a7abead51ca07.patch?full_index=1"

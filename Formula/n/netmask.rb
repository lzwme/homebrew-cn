class Netmask < Formula
  ...
  homepage "https:github.comtlbynetmaskblobmasterREADME"
  url "https:github.comtlbynetmaskarchiverefstagsv2.4.4.tar.gz"
  ...
  test do
    assert_equal "100.64.0.010", shell_output("#{bin}netmask -c 100.64.0.0:100.127.255.255").strip
  end
end
class Id3lib < Formula
  ...
  patch do
    url "https:raw.githubusercontent.comHomebrewformula-patchese223e971id3libautomake.patch"
    sha256 "c1ae2aa04baee7f92301cbed120340682e62e1f839bb61f8f6d3c459a7faf097"
  end

  patch do
    url "https:raw.githubusercontent.comHomebrewformula-patchese223e971id3libboolcheck.patch"
    sha256 "a7881dc25665f284798934ba19092d1eb45ca515a34e5c473accd144aa1a215a"
  end

  # fixes Unicode display problem in easytag: see Homebrewhomebrew-x11#123
  patch do
    url "https:raw.githubusercontent.comHomebrewformula-patchese223e971id3libpatch_id3lib_3.8.3_UTF16_writing_bug.diff"
...
__END__
--- aincludeid3id3lib_strings.h
+++ bincludeid3id3lib_strings.h
@@ -30,6 +30,7 @@
...
+#include <cstring>
 ...
 namespace std
--- aincludeid3writers.h
+++ bincludeid3writers.h
@@ -30,7 +30,7 @@

 #include "id3writer.h"
 #include "id3id3lib_streams.h"
-#include <string.h>
+#include <cstring>

class ConjureUp < Formula
  ...
  url "https://ghproxy.com/https://github.com/conjure-up/conjure-up/archive/2.6.14.tar.gz"
  ...
  resource "env" do
    url "https://ghproxy.com/https://github.com/battlemidget/env/archive/1.0.0.tar.gz"

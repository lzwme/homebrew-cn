class Vips < Formula
  ...
  url "https:github.comlibvipslibvipsreleasesdownloadv8.15.2vips-8.15.2.tar.xz"
  ...
  def install
    # workaround for Xcode 15.3, upstream bug report: https:github.comlibvipslibvipsissues3901

class V8 < Formula
  ...
  url "https:github.comv8v8archiverefstags12.0.267.10.tar.gz"
  ...
  # e.g. for CIPD dependency gn: https:chromium.googlesource.comv8v8.git+refstags<version>DEPS#64
  resource "gn" do
    url "https:gn.googlesource.comgn.git",
        revision: "e4702d7409069c4f12d45ea7b7f0890717ca3f4b"
  end

  resource "v8basetrace_eventcommon" do
    url "https:chromium.googlesource.comchromiumsrcbasetrace_eventcommon.git",
  ...
  resource "v8build" do
    ...
    # Use Arch Linux Chromium package patch to remove some LLVMClang 18 flags
    patch :p2 do
      url "https:gitlab.archlinux.orgarchlinuxpackagingpackageschromium-raw46f81f58f555dc99f5f789167c64950e88c38e63drop-flags-unsupported-by-clang16.patch"
  ...
  def install
    ...
    (buildpath"basetrace_eventcommon").install resource("v8basetrace_eventcommon")
    ...
    (buildpath"buildconfiggclient_args.gni").write <<~EOS
      declare_args() {

class Trdsql < Formula
  ...
  homepage "https:github.comnoborustrdsql"
  url "https:github.comnoborustrdsqlarchiverefstagsv1.1.0.tar.gz"
  sha256 "e3b8bef57330648d3f4b279bd4c652eaeba19aa4fae3fe05cfa596a2b3f4bc51"
  license "MIT"
  head "https:github.comnoborustrdsql.git", branch: "master"
  ...
  def install
    ldflags = "-s -w -X github.comnoborustrdsql.Version=#{version}"
    system "go", "build", *std_go_args(ldflags:), ".cmdtrdsql"
  end

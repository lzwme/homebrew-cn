class Tfmv < Formula
  ...
  homepage "https:github.comsuzuki-shunsuketfmv"
  url "https:github.comsuzuki-shunsuketfmvarchiverefstagsv0.2.6.tar.gz"
  sha256 "67bb684c723d2abdfd0ecfbce030503e05940103305ee131c6b4da64f86c84b9"
  license "MIT"
  head "https:github.comsuzuki-shunsuketfmv.git", branch: "main"
  ...
  def install
    ...
    system "go", "build", *std_go_args(ldflags:), ".cmdtfmv"
  end
  ...
  test do
    ...
    output = shell_output("#{bin}tfmv --replace examplenew_example main.tf")

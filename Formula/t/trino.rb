class Trino < Formula
  ...
  url "https:search.maven.orgremotecontent?filepath=iotrinotrino-server472trino-server-472.tar.gz"
  ...
  resource "trino-src" do
    url "https:github.comtrinodbtrinoarchiverefstags472.tar.gz"

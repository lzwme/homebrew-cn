class TerraformLandscape < Formula
  ...
  homepage "https:github.comcoinbaseterraform-landscape"
  url "https:github.comcoinbaseterraform-landscapearchiverefstagsv0.3.4.tar.gz"
  ...
  resource "treetop" do
    url "https:rubygems.orggemstreetop-1.6.11.gem"
  ...
  def install
    ...
    bin.install libexec"binlandscape"

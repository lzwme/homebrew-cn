class TclTk < Formula
  ...
  url "https:downloads.sourceforge.netprojecttclTcl9.0.0tcl9.0.0-src.tar.gz"
  mirror "https:fossies.orglinuxmisctcl9.0.0-src.tar.gz"
  ...
  resource "tcltls" do
    url "https:core.tcl-lang.orgtcltlstarball6d3664930ctcltls-6d3664930c.tar.gz"
    sha256 "dfd1401f8b0bfa0f2992d480b4e8ba085a4a17dc54e6b0db080e8bd6bdda725f"
  end

  resource "tk" do
    url "https:downloads.sourceforge.netprojecttclTcl9.0.0tk9.0.0-src.tar.gz"
    mirror "https:fossies.orglinuxmisctk9.0.0-src.tar.gz"

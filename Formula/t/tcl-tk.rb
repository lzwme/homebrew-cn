class TclTk < Formula
  ...
  url "https:downloads.sourceforge.netprojecttclTcl8.6.14tcl8.6.14-src.tar.gz"
  mirror "https:fossies.orglinuxmisctcl8.6.14-src.tar.gz"
  ...
  resource "tk" do
    url "https:downloads.sourceforge.netprojecttclTcl8.6.14tk8.6.14-src.tar.gz"
    mirror "https:fossies.orglinuxmisctk8.6.14-src.tar.gz"

class TrezorAgent < Formula
  ...
  resource "python-gnupg" do
    url "https:files.pythonhosted.orgpackages98627737485f44bd4d7d904f4094372f4119195865b29f119fa51a98e121a13apython-gnupg-0.5.1.tar.gz"
  ...
  resource "simple-rlp" do
    url "https:files.pythonhosted.orgpackagesb6b5d379d077e0c38c2b37c64dedfaef16099299e401f6323fc170d16d6c7d43simple-rlp-0.1.3.tar.gz"
    sha256 "2df1d2b769f0a0177d26231ab8be16e65e3546b17bb0a9a490efd3517c082876"
  end

  resource "trezor" do
    url "https:files.pythonhosted.orgpackages36d5e9bca47144ab56148b3c699f52f2576d00f65a359b0c21e6870b0f527f56trezor-0.13.7.tar.gz"

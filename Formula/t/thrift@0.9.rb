class ThriftAT09 < Formula
  ...
  url "https:github.comapachethriftarchiverefstags0.9.3.1.tar.gz"
  ...
  patch do
    url "https:github.comapachethriftcommit4bbfe6120e71b81df7f23dcc246990c29eb27859.patch?full_index=1"
    sha256 "23b29d50cd606b88863153ec8ae1c7b3e1ef0fceca7ec59088b8135f40b99ce6"
  end

  # Fix compile when SSLv3 is disabled (OpenSSL 1.1)
  patch do
    url "https:github.comapachethriftcommitb819260c653f6fd9602419ee2541060ecb930c4c.patch?full_index=1"

class ZabbixCli < Formula
  ...
  url "https:github.comunioslozabbix-cliarchiverefstags3.0.3.tar.gz"
  ...
  resource "click-repl" do
    url "https:files.pythonhosted.orgpackages603011d3f09eff5ae3627bca79563855035e8d241444520500a3c7914eae6a74click-repl-0.2.0.tar.gz"
  ...
  test do
    sample_config = testpath".zabbix-clizabbix-cli.conf"

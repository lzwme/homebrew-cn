class Zstd < Formula
  ...
  url "https:github.comfacebookzstdarchiverefstagsv1.5.5.tar.gz"
  mirror "http:fresh-center.netlinuxmisczstd-1.5.5.tar.gz"
  mirror "http:fresh-center.netlinuxmisclegacyzstd-1.5.5.tar.gz"

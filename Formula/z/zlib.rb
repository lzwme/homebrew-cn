class Zlib < Formula
  ...
  url "https:zlib.netzlib-1.3.tar.gz"
  mirror "https:downloads.sourceforge.netprojectlibpngzlib1.3zlib-1.3.tar.gz"
  mirror "http:fresh-center.netlinuxmisczlib-1.3.tar.gz"
  mirror "http:fresh-center.netlinuxmisclegacyzlib-1.3.tar.gz"

class ZshSystemClipboard < Formula
  ...
  homepage "https:github.comkutsanzsh-system-clipboard"
  url "https:github.comkutsanzsh-system-clipboardarchiverefstagsv0.8.0.tar.gz"
  sha256 "ff048067f018578c380b026952445d3f625160b70475b48827749fb4abb2c886"
  license "GPL-3.0-only"
  head "https:github.comkutsanzsh-system-clipboard.git", branch: "master"
  ...
  def caveats
    <<~EOS
      To activate the system clipboard integration, add the following to your .zshrc:
        ...
        source #{HOMEBREW_PREFIX}sharezsh-system-clipboardzsh-system-clipboard.zsh

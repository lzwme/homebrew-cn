class ProtobufAT36 < Formula
  ...
  url "https://ghproxy.com/https://github.com/protocolbuffers/protobuf/archive/v3.6.1.3.tar.gz"
  ...
  resource "gtest" do
    url "https://ghproxy.com/https://github.com/google/googletest/archive/release-1.8.1.tar.gz"

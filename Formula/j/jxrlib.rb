class Jxrlib < Formula
  ...
  url "https:deb.debian.orgdebianpoolmainjjxrlibjxrlib_1.2~git20170615.f752187.orig.tar.xz"
  ...
  livecheck do
    url "https:deb.debian.orgdebianpoolmainjjxrlib"
    regex(href=.*?jxrlib[._-]v?(\d+(?:\.\d+)+[^"' >]*?)\.orig\.ti)

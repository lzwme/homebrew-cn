class Jbig2dec < Formula
  ...
  homepage "https:github.comArtifexSoftwarejbig2dec"
  url "https:github.comArtifexSoftwarejbig2decarchiverefstags0.20.tar.gz"
  ...
  resource("test") do
    url "https:github.comapachetikarawmastertika-parserssrctestresourcestest-documentstestJBIG2.jb2"

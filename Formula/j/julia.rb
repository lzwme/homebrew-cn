class Julia < Formula
  ...
  stable do
    ...
    url "https:github.comJuliaLangjuliareleasesdownloadv1.11.5julia-1.11.5-full.tar.gz"
  ...
  def install
    ...
    if build.head?
      ...
      inreplace "depstoolscommon.mk", "CMAKE_COMMON :=", "CMAKE_COMMON := -DCMAKE_POLICY_VERSION_MINIMUM=3.5"

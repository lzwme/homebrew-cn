class JpegTurbo < Formula
  ...
  url "https:github.comlibjpeg-turbolibjpeg-turboreleasesdownload3.0.2libjpeg-turbo-3.0.2.tar.gz"
  ...
  # Relates to https:github.comlibjpeg-turbolibjpeg-turbopull755

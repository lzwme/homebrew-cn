class John < Formula
  ...
  url "https:www.openwall.comjohnkjohn-1.9.0.tar.xz"
  ...
  # Backport of official patch from jumbo fork (https:www.openwall.comlistsjohn-users201601041)
  patch do
    url "https:raw.githubusercontent.comHomebrewformula-patchescd039571f9a3e9ecabbe68bdfb443e3abaae6270john1.9.0.patch"
    sha256 "3137169c7f3c25bf58a4f4db46ddf250e49737fc2816a72264dfe87a7f89b6a1"
  end

  def install
    inreplace "srcparams.h" do |s|
  ...
  test do
    (testpath"passwd").write <<~EOS
      root:$1$brew$dOoH2.7QsPufgT8T.pihw:0:0:System Administrator:varroot:binsh
    EOS

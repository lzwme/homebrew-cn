class Googler < Formula
  ...
  homepage "https:github.comjarungoogler"
  url "https:github.comjarungooglerarchiverefstagsv4.3.2.tar.gz"
  sha256 "bd59af407e9a45c8a6fcbeb720790cb9eccff21dc7e184716a60e29f14c68d54"
  license "GPL-3.0-or-later"
  revision 2
  head "https:github.comjarungoogler.git", branch: "main"
  ...
  # https:github.comjarungooglerpull426
  patch do
    url "https:github.comjarungooglercommit52e2da672911cd9186bd3497fcdf81149071e72b.patch?full_index=1"
  ...
  def install
    ...
    bash_completion.install "auto-completionbashgoogler-completion.bash"
    fish_completion.install "auto-completionfishgoogler.fish"
    zsh_completion.install "auto-completionzsh_googler"
  end

class Ghostscript < Formula
  ...
  stable do
    url "https:github.comArtifexSoftwareghostpdl-downloadsreleasesdownloadgs10031ghostpdl-10.03.1.tar.xz"
    ...
    # https:bugs.ghostscript.comshow_bug.cgi?id=707649
    patch do
      url "https:github.comArtifexSoftwareghostpdlcommit90cabe08422afdd16bac5dd9217602679d943045.patch?full_index=1"
  ...
  def install
    ...
    args = %w[--disable-compile-inits
              ...
              --with-system-libtiff
              --without-x]
    # Work around neon detection bug: https:bugs.ghostscript.comshow_bug.cgi?id=707993

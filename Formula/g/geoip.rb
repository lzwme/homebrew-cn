class Geoip < Formula
  ...
  homepage "https:github.commaxmindgeoip-api-c"
  url "https:github.commaxmindgeoip-api-creleasesdownloadv1.6.12GeoIP-1.6.12.tar.gz"
  sha256 "1dfb748003c5e4b7fd56ba8c4cd786633d5d6f409547584f6910398389636f80"
  license "LGPL-2.1-or-later"
  head "https:github.commaxmindgeoip-api-c.git", branch: "main"
  ...
  def post_install
    ...
    legacy_data = Pathname.new "#{HOMEBREW_PREFIX}shareGeoIP"

class GoRice < Formula
  ...
  homepage "https:github.comGeertJohango.rice"
  url "https:github.comGeertJohango.ricearchiverefstagsv1.0.3.tar.gz"
  sha256 "dda8be9c9c594e164e664479001e7113d0f6571b3fc93253ef132096540f0673"
  license "BSD-2-Clause"
  head "https:github.comGeertJohango.rice.git", branch: "master"
  ...
  test do
    ...
    cd "testproject" do
      (testpath"testprojectmain.go").write <<~EOS
        package main

        import (
          "fmt"
          rice "github.comGeertJohango.rice"
        )
      ...
      (testpath"testprojecttemplates").mkpath
      (testpath"testprojecttemplatestest.txt").write "Hello, rice!"

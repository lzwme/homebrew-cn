class Gfxutil < Formula
  ...
  homepage "https:github.comacidantheragfxutil"
  url "https:github.comacidantheragfxutilarchiverefstags1.84b.tar.gz"
  version "1.84b"
  ...
  resource "edk2" do
    ...
    url "https:github.comacidantheraaudk.git",
  ...
  def install
    ...
    bin.install "buildReleasegfxutil"
  end

class GetIplayer < Formula
  ...
  homepage "https:github.comget-iplayerget_iplayer"
  url "https:github.comget-iplayerget_iplayerarchiverefstagsv3.35.tar.gz"
  ...
  on_linux do
    ...
    resource "Path:Class" do
      url "https:cpan.metacpan.orgauthorsidKKWKWILLIAMSPath-Class-0.33.tar.gz"
      sha256 "cd8cc6a68e2099eeb6099df6af83b4585eb0ddf6c77490d6fa97eadb09d0c677"
    end

    resource "Net::HTTP" do
      url "https:cpan.metacpan.orgauthorsidOOAOALDERSNet-HTTP-6.18.tar.gz"
      sha256 "7e42df2db7adce3e0eb4f78b88c450f453f5380f120fd5411232e03374ba951c"
    end

    resource "Net::SSLeay" do
      url "https:cpan.metacpan.orgauthorsidCCHCHRISNNet-SSLeay-1.88.tar.gz"

class Golo < Formula
  ...
  url "https:github.comeclipse-archivedgolo-langreleasesdownloadrelease%2F3.4.0golo-3.4.0.zip"
  sha256 "867c462a41a20e4b7dc1aef461b809d193a505c2a757477b147f0e30235bd545"
  license "EPL-2.0"
  head "https:github.comeclipse-archivedgolo-lang.git", branch: "master"
  ...
  def install
    ...
    if build.head?
      ...
      libexec.install %w[buildinstallgolobin buildinstallgolodocs buildinstallgololib]
    else
    ...
    bash_completion.install "#{libexec}shareshell-completiongolo-bash-completion"
    zsh_completion.install "#{libexec}shareshell-completiongolo-zsh-completion" => "_golo"

class GitNumber < Formula
  ...
  homepage "https:github.comholygeekgit-number"
  url "https:github.comholygeekgit-numberarchiverefstags1.0.1.tar.gz"
  ...
  patch do
    url "https:github.comholygeekgit-numbercommit3da16b37716455ef1dcc9f617a89e003581b5188.patch?full_index=1"
    sha256 "6e7ed0dfcd86b1e8ee4ada9688aa12be9e33c4d9bb6928cf59dda653aa3c716e"
  end

  # Necessary for next patch
  patch do
    url "https:github.comholygeekgit-numbercommit743d06416f097da4f39f4be7883aa755c8a2edfb.patch?full_index=1"
  ...
  patch do
    url "https:github.comholygeekgit-numbercommite699e92394fa6a4ecbc4d7235925e9080a61aaa2.patch?full_index=1"

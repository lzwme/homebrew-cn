class Gdbgui < Formula
  ...
  url "https:files.pythonhosted.orgpackagesd2951a5d6fff8e4c8458b314dd5175944579a0f6233f963c657bc5d3c6b2f3b2gdbgui-0.15.1.0.tar.gz"
  ...
  # No activity since June, 2022 (https:github.comcs01gdbgui).
  ...
  resource "Brotli" do
    url "https:files.pythonhosted.orgpackages2a1870c32fe9357f3eea18598b23aa9ed29b1711c3001835f7cf99a9818985d0Brotli-1.0.9.zip"
    sha256 "4d1b810aa0ed773f81dceda2cc7b403d01057458730e309856356d4ef4188438"
  end

  resource "click" do
    url "https:files.pythonhosted.orgpackages2183308a74ca1104fe1e3197d31693a7a2db67c2d4e668f20f43a2fca491f9f7click-8.0.1.tar.gz"
  ...
  resource "eventlet" do
    url "https:files.pythonhosted.orgpackages810c5e0bcf715a2bae9169c77bfdcbc460a4aeeb0bb1067cf8071cf14d7d1b39eventlet-0.33.3.tar.gz"
  ...
  resource "Flask-SocketIO" do
    url "https:files.pythonhosted.orgpackages5fa55c03d62fdbdf0343345c8cca19d4961d8958eba54449230df2b0080b7011Flask-SocketIO-5.1.1.tar.gz"
    sha256 "1efdaacc7a26e94f2b197a80079b1058f6aa644a6094c0a322349e2b9c41f6b1"
  end

  resource "greenlet" do
    url "https:files.pythonhosted.orgpackages1e1e632e55a04d732c8184201238d911207682b119c35cecbb9a573a6c566731greenlet-2.0.2.tar.gz"
  ...
  resource "Pygments" do
    url "https:files.pythonhosted.orgpackagesda6ac427c06913204e24de28de5300d3f0e809933f376e0b7df95194b2bb3f71Pygments-2.14.0.tar.gz"
    sha256 "b3ed06a9e8ac9a9aae5a6f5dbe78a8a58655d17b43b93c078f094ddc476ae297"
  end

  resource "python-engineio" do
    url "https:files.pythonhosted.orgpackages7eff970c5d084f513fb38108cd7c90497489d7cff8666f9bfabae00a3f4e13d4python-engineio-4.3.4.tar.gz"
    sha256 "d8d8b072799c36cadcdcc2b40d2a560ce09797ab3d2d596b2ad519a5e4df19ae"
  end

  resource "python-socketio" do
    url "https:files.pythonhosted.orgpackagesee56294629986bf6cea96e0edb3933a7f2fac7a079d12909e893903a2effc670python-socketio-5.7.2.tar.gz"

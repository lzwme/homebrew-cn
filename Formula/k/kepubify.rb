class Kepubify < Formula
  ...
  homepage "https:pgaskin.netkepubify"
  url "https:github.compgaskinkepubifyarchiverefstagsv4.0.4.tar.gz"
  sha256 "a3bf118a8e871b989358cb598746efd6ff4e304cba02fd2960fe35404a586ed5"
  license "MIT"
  head "https:github.compgaskinkepubify.git", branch: "master"
  ...
  def install
    %w[
      ...
      system "go", "build", *std_go_args(output: binp, ldflags: "-s -w -X main.version=#{version}"), ".cmd#{p}"
    end
  end

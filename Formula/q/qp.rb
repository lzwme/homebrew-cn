class Qp < Formula
  ...
  homepage "https:github.comf5ioqp"
  url "https:github.comf5ioqparchiverefstags1.0.1.tar.gz"
  ...
  resource "csp-js" do
    url "https:unpkg.com@paybasecsp@1.0.8distesmindex.js"
  ...
  def install
    ...
    resource("csp-js").stage { cp_r "index.js", buildpath"srccsp.js" }

class Devd < Formula
  ...
  homepage "https:github.comcortesidevd"
  license "MIT"
  head "https:github.comcortesidevd.git", branch: "master"

  stable do
    url "https:github.comcortesidevdarchiverefstagsv0.9.tar.gz"
    ...
    # Ref: https:github.comcortesidevdcommit4ab3fc9061542fd35b5544627354e5755fa74c1c
    # TODO: Remove in the next release.
    resource "go.mod" do
      url "https:raw.githubusercontent.comcortesidevd4ab3fc9061542fd35b5544627354e5755fa74c1cgo.mod"
      sha256 "483b4294205cf2dea2d68b8f99aefcf95aadac229abc2a299f4d1303f645e6b0"
    end
    resource "go.sum" do
      url "https:raw.githubusercontent.comcortesidevd4ab3fc9061542fd35b5544627354e5755fa74c1cgo.sum"
  ...
  # Issue ref: https:github.comcortesidevdissues115
  ...
  def install
    if build.stable?
      ...
      # Update xsys to support go 1.17.
      # PR ref: https:github.comcortesidevdpull117
      inreplace "go.mod", "golang.orgxsys v0.0.0-20181221143128-b4a75ba826a6",
                          "golang.orgxsys v0.0.0-20210819135213-f52c844e1c1c"
    ...
    system "go", "build", *std_go_args(ldflags: "-s -w"), ".cmddevd"
  end

class Dvdrtools < Formula
  ...
  livecheck do
    ...
    regex(href=.*?dvdrtools[._-]v?(\d+(?:\.\d+)+)\.ti)
  end
  ...
  patch :p0 do
    url "https:raw.githubusercontent.comHomebrewformula-patches8a41dd4dvdrtoolspatch-cdda2wav-cdda2wav.c"
    sha256 "f792a26af38f63ee1220455da8dba2afc31296136a97c11476d8e3abe94a4a94"
  end

  patch :p0 do
    url "https:raw.githubusercontent.comHomebrewformula-patches8a41dd4dvdrtoolspatch-cdrecord-cdrecord.c"
    sha256 "c7f182ce154785e19235f30d22d3cf56e60f6c9c8cc953a9d16b58205e29a039"
  end

  patch :p0 do
    url "https:raw.githubusercontent.comHomebrewformula-patches8a41dd4dvdrtoolspatch-scsi-mac-iokit.c"

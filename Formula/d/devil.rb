class Devil < Formula
  ...
  homepage "https:sourceforge.netprojectsopenil"
  license "LGPL-2.1-only"
  revision 6
  head "https:github.comDentonWDevIL.git", branch: "master"

  stable do
    url "https:downloads.sourceforge.netprojectopenilDevIL1.8.0DevIL-1.8.0.tar.gz"
    ...
    # under Linux"
    patch do
      url "https:github.comDentonWDevILcommit41fcabbe.patch?full_index=1"
    ...
    # Linux  MacOS, issue #48 at https:github.comDentonWDevILissues48"
    patch do
      url "https:github.comDentonWDevILcommit4a2d7822.patch?full_index=1"
      sha256 "7e74a4366ef485beea1c4285f2b371b6bfa0e2513b83d4d45e4e120690c93f1d"
    end

    # allow compiling against jasper >= 2.0.17
    patch do
      url "https:github.comDentonWDevILcommit42a62648.patch?full_index=1"
...
__END__
diff --git aDevILsrc-ILsrcil_jp2.cpp bDevILsrc-ILsrcil_jp2.cpp
index 89075a52..f46028a9 100644
--- aDevILsrc-ILsrcil_jp2.cpp
+++ bDevILsrc-ILsrcil_jp2.cpp
@@ -323,7 +323,9 @@ ILboolean iLoadJp2Internal(jas_stream_t	*Stream, ILimage *Image)
 
  see: https:github.comOSGeogdalcommit9ef8e16e27c5fc4c491debe50bf2b7f3e94ed334
       https:github.comDentonWDevILissues90

class Dirac < Formula
  ...
  homepage "https:sourceforge.netprojectsdirac"
  url "https:downloads.sourceforge.netprojectdiracdirac-codecDirac-1.0.2dirac-1.0.2.tar.gz"
  mirror "https:launchpad.netubuntu+archiveprimary+filesdirac_1.0.2.orig.tar.gz"
  mirror "https:deb.debian.orgdebianpoolmainddiracdirac_1.0.2.orig.tar.gz"
  ...
  patch do
    url "https:gist.githubusercontent.commistydemeoda8a53abcf057c58b498rawbde69c5f07d871542dcb24792110e29e6418d2a3unititialized-memory.patch"
    sha256 "d5fcbb1b5c9f2f83935d71ebd312e98294121e579edbd7818e3865606da36e10"
  end

  patch do
    url "https:gist.githubusercontent.commistydemeoe729c459525d0d6e9e2drawd9ff69c944b8bde006eef27650c0af36f51479f5dirac-gcc-fixes.patch"
  ...
  patch do
    url "https:raw.githubusercontent.comHomebrewformula-patches85fa66a9dirac1.0.2.patch"

class Digitemp < Formula
  ...
  def install
    mkdir_p "build-serialsrc"
    mkdir_p "build-serialuserialds9097"
    mkdir_p "build-serialuserialds9097u"
    mkdir_p "build-usbsrc"
    mkdir_p "build-usbuserialds2490"
    system "make", "-C", "build-serial", "-f", "..Makefile", "SRCDIR=..", "ds9097", "ds9097u"
    system "make", "-C", "build-usb", "-f", "..Makefile", "SRCDIR=..", "ds2490"
    bin.install "build-serialdigitemp_DS9097"
    bin.install "build-serialdigitemp_DS9097U"
    bin.install "build-usbdigitemp_DS2490"

class Dry < Formula
  ...
  homepage "https:moncho.github.iodry"
  url "https:github.commonchodryarchiverefstagsv0.11.2.tar.gz"
  sha256 "8fdb888f3f0c2298c531d5e23acfc0a55c7e4e881ad7365cc0dbecb8ec6c3b89"
  license "MIT"
  head "https:github.commonchodry.git", branch: "master"
  ...
  def install
    ldflags = %W[
      -s -w
      -X github.commonchodryversion.VERSION=#{version}
      -X github.commonchodryversion.GITCOMMIT=#{tap.user}
    ]

class Dtrx < Formula
  ...
  homepage "https:pypi.orgprojectdtrx"
  url "https:files.pythonhosted.orgpackagesb7e6204294b57be7bb5072c217a1c3ddd5acf9b60b006c215e13e11121c04108dtrx-8.5.3.tar.gz"
  ...
  # Issue ref: https:github.comdtrx-pydtrxissues58
  # PR ref: https:github.comdtrx-pydtrxpull59
  patch do
    url "https:github.comdtrx-pydtrxcommit4f2868c87e7d2eef97c9dbcbea4d1738e947463d.patch?full_index=1"

class Depqbf < Formula
  ...
  homepage "https:lonsing.github.iodepqbf"
  url "https:github.comlonsingdepqbfarchiverefstagsversion-6.03.tar.gz"
  ...
  resource "nenofex" do
    url "https:github.comlonsingnenofexarchiverefstagsversion-1.1.tar.gz"

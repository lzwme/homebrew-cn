class Audiofile < Formula
  ...
  stable do
    url "https:audiofile.68k.orgaudiofile-0.3.6.tar.gz"
    ...
    # https:github.commpruettaudiofilecommitb62c902dd258125cac86cd2df21fc898035a43d3
    patch do
      url "https:deb.debian.orgdebianpoolmainaaudiofileaudiofile_0.3.6-5.debian.tar.xz"
      sha256 "7ae94516b5bfea75031c5bab1e9cccf6a25dd438f1eda40bb601b8ee85a07daa"
      apply "patches03_CVE-2015-7747.patch"
    end
  end
  ...
  head do
    url "https:github.commpruettaudiofile.git", branch: "master"
  ...
  resource "aiff" do
    url "https:mmsp.ece.mcgill.caDocumentsAudioFormatsAIFFSamplesCCRMAwood24.aiff"
  ...
  # https:github.commpruettaudiofileissues31
  # https:github.commpruettaudiofileissues32
  # https:github.commpruettaudiofileissues33
  # https:github.commpruettaudiofileissues34
  # https:github.commpruettaudiofileissues35
  # https:github.commpruettaudiofileissues36
  # https:github.commpruettaudiofileissues37
  # https:github.commpruettaudiofileissues38
  # https:github.commpruettaudiofileissues39
  # https:github.commpruettaudiofileissues40
  # https:github.commpruettaudiofileissues41
  # https:github.commpruettaudiofilepull42
  patch do
    url "https:deb.debian.orgdebianpoolmainaaudiofileaudiofile_0.3.6-5.debian.tar.xz"
    sha256 "7ae94516b5bfea75031c5bab1e9cccf6a25dd438f1eda40bb601b8ee85a07daa"
    apply "patches04_clamp-index-values-to-fix-index-overflow-in-IMA.cpp.patch",
          "patches05_Always-check-the-number-of-coefficients.patch",
          "patches06_Check-for-multiplication-overflow-in-MSADPCM-decodeSam.patch",
          "patches07_Check-for-multiplication-overflow-in-sfconvert.patch",
          "patches08_Fix-signature-of-multiplyCheckOverflow.-It-returns-a-b.patch",
          "patches09_Actually-fail-when-error-occurs-in-parseFormat.patch",
          "patches10_Check-for-division-by-zero-in-BlockCodec-runPull.patch"
  end

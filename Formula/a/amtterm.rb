class Amtterm < Formula
  ...
  homepage "https:www.kraxel.orgbloglinuxamtterm"
  url "https:www.kraxel.orgreleasesamttermamtterm-1.7.tar.gz"
  sha256 "8c58b76b3237504d751bf3588fef25117248a0569523f0d86deaf696d14294d4"
  license "GPL-2.0-or-later"
  head "https:github.comkraxelamtterm.git", branch: "master"

  livecheck do
    url "https:www.kraxel.orgreleasesamtterm"
    regex(href=.*?amtterm[._-]v?(\d+(?:\.\d+)+)\.ti)
  end
  ...
  resource "SOAP::Lite" do
    url "https:cpan.metacpan.orgauthorsidPPHPHREDSOAP-Lite-1.27.tar.gz"
  ...
  def install
    ...
    inreplace "mkAutoconf.mk", "@echo -e", "@echo"

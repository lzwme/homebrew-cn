class ApiLinter < Formula
  ...
  url "https:github.comgoogleapisapi-linterarchiverefstagsv1.69.2.tar.gz"
  sha256 "a6c10a8d0b9a9186db3419075adae497f5fa169113a22a742c05444e711dbaf0"
  license "Apache-2.0"
  head "https:github.comgoogleapisapi-linter.git", branch: "main"
  ...
  def install
    system "go", "build", *std_go_args(ldflags: "-s -w"), ".cmdapi-linter"
  end

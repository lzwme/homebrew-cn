class Alejandra < Formula
  ...
  homepage "https:kamadorueda.comalejandra"
  url "https:github.comkamadoruedaalejandraarchiverefstags4.0.0.tar.gz"
  ...
  def install
    system "cargo", "install", *std_cargo_args(path: "srcalejandra_cli")
  end

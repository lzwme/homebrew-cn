class Aacgain < Formula
  ...
  # See: https:github.comHomebrewhomebrewissues16838
  url "https:aacgain.altosdesign.comalvarezaacgain-1.8.tar.bz2"
  ...
  test do
    ...
    # See: https:github.comHomebrewhomebrewpull37080

class Aldo < Formula
  ...
  # Reported upstream:
  # https:savannah.nongnu.orgbugsindex.php?42127
  patch do
    url "https:raw.githubusercontent.comHomebrewformula-patches85fa66a9aldo0.7.7.patch"

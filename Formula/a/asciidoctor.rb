class Asciidoctor < Formula
  ...
  url "https:github.comasciidoctorasciidoctorarchiverefstagsv2.0.20.tar.gz"
  ...
  # https:rubygems.orggemsasciidoctor-pdfversions2.3.7dependencies
  ...
  resource "public_suffix" do
    url "https:rubygems.orggemspublic_suffix-5.0.1.gem"
  ...
  resource "addressable" do
    url "https:rubygems.orggemsaddressable-2.8.4.gem"
  ...
  resource "prawn-svg" do
    url "https:rubygems.orggemsprawn-svg-0.32.0.gem"
  ...
  resource "pdf-reader" do
    url "https:rubygems.orggemspdf-reader-2.11.0.gem"
  ...
  # rouge 4.1.1
  resource "rouge" do
    url "https:rubygems.orggemsrouge-4.1.1.gem"

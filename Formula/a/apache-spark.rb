class ApacheSpark < Formula
  ...
  url "https:dlcdn.apache.orgsparkspark-4.0.0spark-4.0.0-bin-hadoop3.tgz"
  mirror "https:archive.apache.orgdistsparkspark-4.0.0spark-4.0.0-bin-hadoop3.tgz"
  version "4.0.0"
  ...
  test do
    ...
    assert_match "String = abitrivial", output
  end
end
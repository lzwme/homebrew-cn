class AnimeDownloader < Formula
  ...
  homepage "https:github.comanime-dlanime-downloader"
  url "https:files.pythonhosted.orgpackages008b2f354c0c2e56f1fe45e805698bd6a81c472473a48b814c44aaed2d41016danime-downloader-5.0.9.tar.gz"
  ...
  resource "attrs" do
    url "https:files.pythonhosted.orgpackages1acbc4ffeb41e7137b23755a45e1bfec9cbb76ecf51874c6f1d113984ecaa32cattrs-22.1.0.tar.gz"
  ...
  resource "cattrs" do
    url "https:files.pythonhosted.orgpackagesfcdaff3239eb4241cbc6f8b69f53d4ca27a178d51f9e5a954f1a3588c8227dc5cattrs-22.2.0.tar.gz"
    sha256 "f0eed5642399423cf656e7b66ce92cdc5b963ecafd041d1b24d136fdde7acf6d"
  end

  resource "cfscrape" do
    url "https:files.pythonhosted.orgpackagesa63d12044a9a927559b2fe09d60b1cd6cd4ed1e062b7a28f15c91367b9ec78f1cfscrape-2.1.1.tar.gz"
  ...
  resource "fuzzywuzzy" do
    url "https:files.pythonhosted.orgpackages114b0a002eea91be6048a2b5d53c5f1b4dafd57ba2e36eea961d05086d7c28cefuzzywuzzy-0.18.0.tar.gz"
  ...
  resource "pycryptodome" do
    url "https:files.pythonhosted.orgpackages0d665e4a14e91ffeac819e6888037771286bc1b86869f25d74d60bc4a61d2c1epycryptodome-3.16.0.tar.gz"
  ...
  resource "requests-cache" do
    url "https:files.pythonhosted.orgpackages660240737a22e3c006830433d6dc9e9d6debb52d9e9e412bab16d82c50d7be14requests_cache-0.9.7.tar.gz"

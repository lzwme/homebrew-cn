class AflFuzz < Formula
  ...
  homepage "https:github.comgoogleAFL"
  url "https:github.comgoogleAFLarchiverefstagsv2.57b.tar.gz"
  version "2.57b"
  ...
  def install
    ...
    rm Dir[share"afl**elfsmall_exec.elf"]
  end
  ...
  test do
    ...
    system bincmd, "-g", cpp_file, "-o", "test"

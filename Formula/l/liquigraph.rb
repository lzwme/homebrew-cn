class Liquigraph < Formula
  ...
  url "https:github.comliquibaseliquigrapharchiverefstagsliquigraph-4.0.6.tar.gz"
  sha256 "c51283a75346f8d4c7bb44c6a39461eb3918ac5b150ec3ae157f9b12c4150566"
  license "Apache-2.0"
  head "https:github.comliquibaseliquigraph.git", branch: "4.x"
  ...
  def install
    ...
    system "tar", "xzf", "liquigraph-clitargetliquigraph-cli-bin.tar.gz", "-C", "binaries"
    libexec.install "binariesliquigraph-cliliquigraph.sh"
    libexec.install "binariesliquigraph-cliliquigraph-cli.jar"

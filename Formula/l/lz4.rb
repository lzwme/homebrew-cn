class Lz4 < Formula
  ...
  url "https:github.comlz4lz4archiverefstagsv1.9.4.tar.gz"
  mirror "http:fresh-center.netlinuxmisclz4-1.9.4.tar.gz"
  mirror "http:fresh-center.netlinuxmisclegacylz4-1.9.4.tar.gz"

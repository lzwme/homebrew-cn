class Lz4 < Formula
  ...
  homepage "https:lz4.github.iolz4"
  url "https:github.comlz4lz4archiverefstagsv1.10.0.tar.gz"
  mirror "http:fresh-center.netlinuxmisclz4-1.10.0.tar.gz"
  mirror "http:fresh-center.netlinuxmisclegacylz4-1.10.0.tar.gz"
  sha256 "537512904744b35e232912055ccf8ec66d768639ff3abe5788d90d792ec5f48b"
  license "BSD-2-Clause"
  head "https:github.comlz4lz4.git", branch: "dev"
  ...
  def install
    ...
    inreplace lib"pkgconfigliblz4.pc", prefix, opt_prefix
  end

class LlvmAT13 < Formula
  ...
  url "https:github.comllvmllvm-projectreleasesdownloadllvmorg-13.0.1llvm-project-13.0.1.src.tar.xz"
  ...
  def install
    ...
    if OS.mac?
      ...
      xctoolchain = prefix"ToolchainsLLVM#{version}.xctoolchain"
      ...
      system "usrlibexecPlistBuddy", "-c", "Add:CFBundleIdentifier string org.llvm.#{version}", "Info.plist"
      system "usrlibexecPlistBuddy", "-c", "Add:CompatibilityVersion integer #{compat_version}", "Info.plist"

class Luabind < Formula
  ...
  homepage "https:github.comluabindluabind"
  url "https:downloads.sourceforge.netprojectluabindluabind0.9.1luabind-0.9.1.tar.gz"
  ...
  # https:github.comHomebrewhomebrewpull33890#issuecomment-67723688
  # https:github.comluabindluabindissues27
  patch do
    url "https:gist.githubusercontent.comtdsmithe6d9d3559ec1d9284c0braw4ac01936561ef9d7541cf8e78a230bebef1a8e10luabind.diff"
  ...
  patch do
    url "https:gist.githubusercontent.comDennisOSRM3728987raw052251fcdc23602770f6c543be9b3e12f0cac50aJamroot.diff"
  ...
  patch do
    url "https:github.comluabindluabindcommit3044a9053ac50977684a75c4af42b2bddb853fad.patch?full_index=1"
  ...
  # submitted https:github.comluabindluabindpull20
  patch do
    url "https:gist.githubusercontent.comDennisOSRMa246514bf7d01631dda8raw0e83503dbf862ebfb6ac063338a6d7bca793f94dobject_rep.diff"
  ...
  def install
    ...
    (lib"pkgconfigluabind.pc").write pc_file
  end
  ...
  test do
    ...
    output = shell_output("lua5.1 -e \"package.loadlib('#{testpathshared_library("hello")}', 'init')(); greet()\"")

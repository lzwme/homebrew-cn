class Lunasvg < Formula
  ...
  homepage "https:github.comsammycagelunasvg"
  url "https:github.comsammycagelunasvgarchiverefstagsv3.3.0.tar.gz"
  ...
  def install
    ...
    (pkgshare"examples").install "examplessvg2png.cpp"
  end
  ...
  test do
    ...
    system ENV.cxx, pkgshare"examplessvg2png.cpp", "-o", "svg2png", *args

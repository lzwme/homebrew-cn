class SentryNative < Formula
  ...
  resource "breakpad" do
    url "https:github.comgetsentrybreakpad",
  ...
  resource "crashpad" do
    url "https:github.comgetsentrycrashpad",
  ...
  resource "libunwindstack-ndk" do
    url "https:github.comgetsentrylibunwindstack-ndk",
  ...
  resource "third-partylss" do
    url "https:chromium.googlesource.comlinux-syscall-support",
      tag:      "v2024.02.01",

class Subliminal < Formula
  ...
  license "MIT"
  revision 2
  head "https:github.comDiaoulsubliminal.git", branch: "master"
  ...
  # https:github.comDiaoulsubliminalissues1046
  ...
  resource "guessit" do
    url "https:files.pythonhosted.orgpackages5f4a3d500ee6e59141b81160aa0e9368aae0b0780f987bbbddcb97bc9e906f76guessit-3.5.0.tar.gz"
  ...
  resource "rarfile" do
    url "https:files.pythonhosted.orgpackages0c2f894bc187ce40367f2e878ced196e1b5a9bc66cb553a062ed955d4f7dcbabrarfile-4.0.tar.gz"
    sha256 "67548769229c5bda0827c1663dce3f54644f9dbfba4ae86d4da2b2afd3e602a1"
  end

  resource "rebulk" do
    url "https:files.pythonhosted.orgpackages662353c95f819f0a91c30254a594e2357550db6d3ed125ed2b5ff0eae19a58d7rebulk-3.1.0.tar.gz"

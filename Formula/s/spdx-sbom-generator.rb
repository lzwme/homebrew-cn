class SpdxSbomGenerator < Formula
  ...
  homepage "https:github.comopensbom-generatorspdx-sbom-generator"
  url "https:github.comopensbom-generatorspdx-sbom-generatorarchiverefstagsv0.0.15.tar.gz"
  ...
  test do
    system "go", "mod", "init", "example.comtester"

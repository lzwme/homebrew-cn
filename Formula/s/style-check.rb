class StyleCheck < Formula
  ...
  homepage "https:www.cs.umd.edu~nspringsoftwarestyle-check-readme.html"
  url "https:www.cs.umd.edu~nspringsoftwarestyle-check-0.14.tar.gz"
  ...
  # and the GitHub repository (https:github.comnspringstyle-check) has no
  # tags.
  livecheck do
  ...
  def install
    inreplace "style-check.rb", "etcstyle-check.d", etc"style-check.d"
...
__END__
diff --git astyle-check.rb bstyle-check.rb

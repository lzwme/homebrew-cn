class SaxonB < Formula
  ...
  url "https:downloads.sourceforge.netprojectsaxonSaxon-B9.1.0.8saxonb9-1-0-8j.zip"
  version "9.1.0.8"
  sha256 "92bcdc4a0680c7866fe5828adb92c714cfe88dcf3fa0caf5bf638fcc6d9369b4"
  # The `cannot_represent` is for an older (2007) variation of Unicode-DFS-2015 (see noticesUNICODE.txt for details)
  ...
  #
  # Ref: https:www.saxonica.comhtmldocumentation12changesv9.2installation.html
  # Ref: https:www.saxonica.comdownloadinformation.xml#earlier
  # Ref: https:github.comSaxonicaSaxon-Archive
  # Ref: https:github.comHomebrewlegacy-homebrewpull10634
  livecheck do

class SdlTtf < Formula
  ...
  stable do
    url "https:www.libsdl.orgprojectsSDL_ttfreleaseSDL_ttf-2.0.11.tar.gz"
    sha256 "724cd895ecf4da319a3ef164892b72078bd92632a5d812111261cde248ebcdb7"

    # Fix broken TTF_RenderGlyph_Shaded()
    # https:bugzilla.libsdl.orgshow_bug.cgi?id=1433
    patch do
      url "https:gist.githubusercontent.comtomyuna8d2193b6e18218217c4raw8292c48e751c6a9939db89553d01445d801420ddsdl_ttf-fix-1433.diff"
  ...
  head do
    url "https:github.comlibsdl-orgSDL_ttf.git", branch: "SDL-1.2"

class Sphinx < Formula
  ...
  url "https:sphinxsearch.comfilessphinx-2.2.11-release.tar.gz"
  sha256 "6662039f093314f896950519fa781bc87610f926f64b3d349229002f06ac41a9"
  license "GPL-2.0-or-later"
  revision 4
  head "https:github.comsphinxsearchsphinx.git", branch: "master"
  ...
  # Ref: https:github.comsphinxsearchsphinx#sphinx
  ...
  resource "stemmer" do
    url "https:github.comsnowballstemsnowball.git",
        revision: "9b58e92c965cd7e3208247ace3cc00d173397f3c"
  end

  patch do
    url "https:sources.debian.orgdatamainssphinxsearch2.2.11-8debianpatches06-CVE-2020-29050.patch"
  ...
  def install
    resource("stemmer").stage do
      ...
      system "tar", "xzf", "distlibstemmer_c.tgz", "-C", buildpath
    end
    ...
    # https:sources.debian.orgdatamainssphinxsearch2.2.11-8debianpatchesconfig-default-to-localhost.patch

class SdlNet < Formula
  ...
  homepage "https:www.libsdl.orgprojectsSDL_netrelease-1.2.html"
  url "https:www.libsdl.orgprojectsSDL_netreleaseSDL_net-1.2.8.tar.gz"
  ...
  head do
    url "https:github.comlibsdl-orgSDL_net.git", branch: "SDL-1.2"

class Subversion < Formula
  ...
  stable do
    url "https:www.apache.orgdyncloser.lua?path=subversionsubversion-1.14.2.tar.bz2"
    mirror "https:archive.apache.orgdistsubversionsubversion-1.14.2.tar.bz2"
  ...
  resource "py3c" do
    url "https:github.comencukoupy3carchiverefstagsv1.1.tar.gz"

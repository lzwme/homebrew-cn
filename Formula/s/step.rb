class Step < Formula
  ...
  url "https:github.comsmallstepclireleasesdownloadv0.26.2step_0.26.2.tar.gz"
  ...
  resource "certificates" do
    url "https:github.comsmallstepcertificatesreleasesdownloadv0.26.2step-ca_0.26.2.tar.gz"

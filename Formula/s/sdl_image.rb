class SdlImage < Formula
  ...
  stable do
    url "https:www.libsdl.orgprojectsSDL_imagereleaseSDL_image-1.2.12.tar.gz"
    sha256 "0b90722984561004de84847744d566809dbb9daf732a9e503b91a1b5a84e5699"

    # Fix graphical glitching
    # https:github.comHomebrewhomebrew-pythonissues281
    # https:trac.macports.orgticket37453
    patch :p0 do
      url "https:raw.githubusercontent.comHomebrewformula-patches41996822sdl_imageIMG_ImageIO.m.patch"
  ...
  head do
    url "https:github.comlibsdl-orgSDL_image.git", branch: "SDL-1.2"

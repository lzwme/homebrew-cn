class Sslyze < Formula
  ...
  desc "SSL scanner"
  homepage "https:github.comnabla-c0d3sslyze"
  license "AGPL-3.0-only"

  stable do
    url "https:files.pythonhosted.orgpackages1300bacbb04d7d3e0d7db3cedec0b7a450a6ee9543aa4929b020a329f184daaesslyze-5.1.3.tar.gz"
    sha256 "247eeed21e57cb5bfe8bd5565f83a35988cfad5c8294120fa7b729bd5e5cf949"

    resource "nassl" do
      url "https:github.comnabla-c0d3nasslarchiverefstags5.0.1.tar.gz"
  ...
  head do
    url "https:github.comnabla-c0d3sslyze.git", branch: "release"

    resource "nassl" do
      url "https:github.comnabla-c0d3nassl.git", branch: "release"
    end
  end
  ...
  resource "cryptography" do
    url "https:files.pythonhosted.orgpackagesfaf3f4b8c175ea9a1de650b0085858059050b7953a93d66c97ed89b93b232996cryptography-39.0.2.tar.gz"
    sha256 "bc5b871e977c8ee5a1bbc42fa8d19bcc08baf0c51cbf1586b0e87a2694dde42f"
  end

  resource "pydantic" do
    url "https:files.pythonhosted.orgpackages8b87200171b36005368bc4c114f01cb9e8ae2a3f3325a47da8c710cc58cfd00cpydantic-1.10.6.tar.gz"
  ...
  resource "tls-parser" do
    url "https:files.pythonhosted.orgpackages12fc282d5dd9e90d3263e759b0dfddd63f8e69760617a56b49ea4882f40a5fc5tls_parser-2.0.0.tar.gz"

class SlitherAnalyzer < Formula
  ...
  resource "cbor2" do
    url "https:files.pythonhosted.orgpackagesd637a0a75c2cae532ecb155d05edc1fbbe54fa3957e86f875a38542f87e1379ccbor2-5.5.1.tar.gz"
  ...
  resource "cytoolz" do
    url "https:files.pythonhosted.orgpackagesa061c27e1e7007e3cc6989053956dfe078db84e164f22c7000b2ad1efc5b93b7cytoolz-0.12.2.tar.gz"
    sha256 "31d4b0455d72d914645f803d917daf4f314d115c70de0578d3820deb8b101f66"
  end

  resource "eth-abi" do
    url "https:files.pythonhosted.orgpackagesdc7002882ae2533ed4d53233481e516652c47d26c61b1ff76dee1241b5c3d049eth_abi-4.2.1.tar.gz"
  ...
  resource "eth-hash" do
    url "https:files.pythonhosted.orgpackages33980a5ff6036b36018db5a728e1e1691457df191bba10a95a912d456b6d1e73eth-hash-0.5.2.tar.gz"
    sha256 "1b5f10eca7765cc385e1430eefc5ced6e2e463bb18d1365510e2e539c1a6fe4e"
  end

  resource "eth-keyfile" do
    url "https:files.pythonhosted.orgpackages608eaffe6f0d1c0f02c8bbdf900cb57c5a4b97410ff341807fc3107484d2a58feth-keyfile-0.6.1.tar.gz"
    sha256 "471be6e5386fce7b22556b3d4bde5558dbce46d2674f00848027cb0a20abdc8c"
  end

  resource "eth-keys" do
    url "https:files.pythonhosted.orgpackagese42403295c85b09f17d0d002d5cfca54614dc68e9ceaa4c8978267a1f6d75299eth-keys-0.4.0.tar.gz"
    sha256 "7d18887483bc9b8a3fdd8e32ddcb30044b9f08fcb24a380d93b6eee3a5bb3216"
  end

  resource "eth-rlp" do
    url "https:files.pythonhosted.orgpackagesf3a22e6ff6eb74820a0fb5716787cb06fc9ae5035092cd830d99de83ff11197beth-rlp-0.3.0.tar.gz"
    sha256 "f3263b548df718855d9a8dbd754473f383c0efc82914b0b849572ce3e06e71a6"
  end

  resource "eth-typing" do
    url "https:files.pythonhosted.orgpackagesc852f5d10803345dd06f9301b4871e8ebb39971a4238b60c61f84ffc83379611eth-typing-3.5.2.tar.gz"
    sha256 "22bf051ddfaa35ff827c30090de167e5c5b8cc6d343f7f35c9b1c7553f6ab64d"
  end

  resource "eth-utils" do
    url "https:files.pythonhosted.orgpackages7c178a43def3267f25df94fc0d3ef66a76b00aee7bab35b1d2ff41400eedec1aeth-utils-2.3.1.tar.gz"
  ...
  resource "pypandoc" do
    url "https:files.pythonhosted.orgpackagescd107042e44e0b5020d075cd61c93dc6c26d618e5a1f4f1d2cd493fe54ab124dpypandoc-1.7.5.tar.gz"
  ...
  resource "rlp" do
    url "https:files.pythonhosted.orgpackages20638b5205a7f9e2792137676c2d29bd6bc9cbecca95015a55ed54d6dd02f3f6rlp-3.0.0.tar.gz"
  ...
  resource "web3" do
    url "https:files.pythonhosted.orgpackages402a0070855171b7f68d51952b90a4b35eb78c8a5f90db644cb372b60d7fae4dweb3-6.11.4.tar.gz"
  ...
  resource "yarl" do
    url "https:files.pythonhosted.orgpackagescaf72af788563995eeec32b920c0640a6bc54777c89c780030a7754f95166b7fyarl-1.9.3.tar.gz"
  ...
  def install
    ...
    (libexecsite_packages"homebrew-crytic-compile.pth").write crytic_compilesite_packages

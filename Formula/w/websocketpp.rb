class Websocketpp < Formula
  ...
  # cannot run with asio 1.34.2, upstream issue, https:github.comzaphoydwebsocketppissues1169
  ...
  def install
    # cmake 4.0 support PR, https:github.comzaphoydwebsocketpppull1168

class Webdav < Formula
  ...
  homepage "https:github.comhacdiaswebdav"
  url "https:github.comhacdiaswebdavarchiverefstagsv5.8.0.tar.gz"
  ...
  def install
    ldflags = "-s -w -X github.comhacdiaswebdavv5cmd.version=#{version}"

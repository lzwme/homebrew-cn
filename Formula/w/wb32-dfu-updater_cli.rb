class Wb32DfuUpdaterCli < Formula
  desc "USB programmer for downloading and uploading firmware tofrom USB devices"
  homepage "https:github.comWestberryTechwb32-dfu-updater"
  url "https:github.comWestberryTechwb32-dfu-updaterarchiverefstags1.0.0.tar.gz"

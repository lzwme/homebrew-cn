class Web100clt < Formula
  ...
  homepage "https:software.internet2.edundt"
  url "https:software.internet2.edusourcesndtndt-3.7.0.2.tar.gz"
  ...
  # fixes issue with new default secure strlcpystrlcat functions in 10.9
  # https:github.comndt-projectndtissues106
  patch do
    on_macos do
      url "https:raw.githubusercontent.comHomebrewformula-patches37aa64888341web100cltndt-3.6.5.2-osx-10.9.patch"
  ...
  def install
    ...
    man1.install "docweb100clt.man" => "web100clt.1"
  end

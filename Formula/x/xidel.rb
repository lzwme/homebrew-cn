class Xidel < Formula
  desc "XPathXQuery 3.0, JSONiq interpreter to extract data from HTMLXMLJSON"
  homepage "https:www.videlibri.dexidel.html"
  url "https:github.combenibelaxidelreleasesdownloadXidel_0.9.8xidel-0.9.8.src.tar.gz"
  ...
  head do
    url "https:github.combenibelaxidel.git", branch: "master"
    resource("flre") { url "https:github.combenibelaflre.git", branch: "master" }

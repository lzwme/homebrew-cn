class X265 < Formula
  ...
  url "https:bitbucket.orgmulticorewarex265_gitdownloadsx265_4.0.tar.gz"
  ...
  def install
    ...
    mkdir "10bit" do
      ...
      system "make"
      mv "libx265.a", buildpath"8bitlibx265_main10.a"
    end

    mkdir "12bit" do
      system "cmake", buildpath"source", "-DMAIN12=ON", *high_bit_depth_args
      system "make"
      mv "libx265.a", buildpath"8bitlibx265_main12.a"
    end

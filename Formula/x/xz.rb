class Xz < Formula
  ...
  homepage "https:xz.tukaani.orgxz-utils"
  # The archive.org mirror below needs to be manually created at `archive.org`.
  url "https:github.comtukaani-projectxzreleasesdownloadv5.6.1xz-5.6.1.tar.gz"
  mirror "https:downloads.sourceforge.netprojectlzmautilsxz-5.6.1.tar.gz"
  mirror "https:archive.orgdownloadxz-5.6.1.tar.gzxz-5.6.1.tar.gz"
  mirror "http:archive.orgdownloadxz-5.6.1.tar.gzxz-5.6.1.tar.gz"

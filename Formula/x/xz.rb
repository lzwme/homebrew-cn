class Xz < Formula
  ...
  url "https:github.comtukaani-projectxzreleasesdownloadv5.6.3xz-5.6.3.tar.gz"
  mirror "https:downloads.sourceforge.netprojectlzmautilsxz-5.6.3.tar.gz"
  mirror "https:archive.orgdownloadxz-5.6.3.tarxz-5.6.3.tar.gz"
  mirror "http:archive.orgdownloadxz-5.6.3.tarxz-5.6.3.tar.gz"

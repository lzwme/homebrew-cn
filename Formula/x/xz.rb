class Xz < Formula
  ...
  url "https:github.comtukaani-projectxzreleasesdownloadv5.6.4xz-5.6.4.tar.gz"
  mirror "https:downloads.sourceforge.netprojectlzmautilsxz-5.6.4.tar.gz"
  mirror "http:downloads.sourceforge.netprojectlzmautilsxz-5.6.4.tar.gz"

class Xz < Formula
  ...
  url "https:github.comtukaani-projectxzreleasesdownloadv5.6.2xz-5.6.2.tar.gz"
  mirror "https:downloads.sourceforge.netprojectlzmautilsxz-5.6.2.tar.gz"
  mirror "https:archive.orgdownloadxz-5.6.2.tarxz-5.6.2.tar.gz"
  mirror "http:archive.orgdownloadxz-5.6.2.tarxz-5.6.2.tar.gz"

class Xz < Formula
  ...
  url "https:github.comtukaani-projectxzreleasesdownloadv5.8.0xz-5.8.0.tar.gz"
  mirror "https:downloads.sourceforge.netprojectlzmautilsxz-5.8.0.tar.gz"
  mirror "http:downloads.sourceforge.netprojectlzmautilsxz-5.8.0.tar.gz"

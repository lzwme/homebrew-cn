class PhpAT73Debug < Formula
  ...
  def post_install
    ...
    pear_path = HOMEBREW_PREFIX"sharepear@#{version.major_minor}-debug"
    cp_r pkgshare"pear.", pear_path
    {
      "php_ini"  => etc"php#{version.major_minor}-debugphp.ini",
      "php_dir"  => pear_path,
    ...
    %w[
      ...
      ext_config_path = etc"php#{version.major_minor}-debugconf.dext-#{e}.ini"

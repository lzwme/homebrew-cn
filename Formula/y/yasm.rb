class Yasm < Formula
  ...
  livecheck do
    url "https:yasm.tortall.netDownload.html"
    regex(href=.*?yasm[._-]v?(\d+(?:\.\d+)+)\.ti)
  end
  ...
  head do
    url "https:github.comyasmyasm.git", branch: "master"
  ...
  def install
    ...
    # https:github.comHomebrewlegacy-homebrewpull19593
    ENV.deparallelize

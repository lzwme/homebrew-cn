class Yconalyzer < Formula
  ...
  homepage "https:sourceforge.netprojectsyconalyzer"
  url "https:downloads.sourceforge.netprojectyconalyzeryconalyzer-1.0.4.tar.bz2"
  ...
  # Fix build issues issue on OS X 10.9clang
  # Patch reported to upstream - https:sourceforge.netpyconalyzerbugs3
  patch :p0 do
    url "https:raw.githubusercontent.comHomebrewformula-patches85fa66a9yconalyzer1.0.4.patch"

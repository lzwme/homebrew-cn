class Ykclient < Formula
  ...
  homepage "https:developers.yubico.comyubico-c-client"
  license "BSD-2-Clause"
  revision 1

  stable do
    url "https:developers.yubico.comyubico-c-clientReleasesykclient-2.15.tar.gz"
    ...
    patch do
      url "https:github.comYubicoyubico-c-clientcommit0d45452e7fbe47e77e78ff23b480c77fd9c06f2b.patch?full_index=1"
  ...
  head do
    url "https:github.comYubicoyubico-c-client.git"
  ...
  # applications, see
  # https:status.yubico.com20210415one-api-yubico-com-one-http-get."
  #

class Yafc < Formula
  ...
  homepage "https:github.comsebastinasyafc"
  url "https:deb.debian.orgdebianpoolmainyyafcyafc_1.3.7.orig.tar.xz"
  ...
  test do
    ...
    output = pipe_output("#{bin}yafc -W #{testpath} -a ftp:ftp.gnu.orggnugccgcc-10.2.0",

class PhpDebugZts < Formula
  ...
  url "https:www.php.netdistributionsphp-8.3.11.tar.xz"
  mirror "https:fossies.orglinuxwwwphp-8.3.11.tar.xz"
  sha256 "b862b098a08ab9bf4b36ed12c7d0d9f65353656b36fb0e3c5344093aceb35802"
  license "PHP-3.01"

  livecheck do
    url "https:www.php.netdownloads"
    regex(href=.*?php[._-]v?(\d+(?:\.\d+)+)\.ti)
  end
  ...
  head do
    url "https:github.comphpphp-src.git", branch: "master"
  ...
  def post_install
    ...
    pear_path = HOMEBREW_PREFIX"sharepear-debug-zts"

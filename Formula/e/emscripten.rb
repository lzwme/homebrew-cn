class Emscripten < Formula
  ...
  url "https:github.comemscripten-coreemscriptenarchiverefstags3.1.70.tar.gz"
  ...
  resource "llvm" do
    url "https:github.comllvmllvm-projectarchive5d07162bba0648f5a5733039a7795eb7e9913863.tar.gz"

class Emscripten < Formula
  ...
  url "https:github.comemscripten-coreemscriptenarchiverefstags3.1.74.tar.gz"
  ...
  resource "llvm" do
    url "https:github.comllvmllvm-projectarchive322eb1a92e6d4266184060346616fa0dbe39e731.tar.gz"

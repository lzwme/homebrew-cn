class Emscripten < Formula
  ...
  url "https:github.comemscripten-coreemscriptenarchiverefstags4.0.1.tar.gz"
  ...
  resource "llvm" do
    url "https:github.comllvmllvm-projectarchivea32e36faf84bd7da3df0c7d50bb9020568128417.tar.gz"

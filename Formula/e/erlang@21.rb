class ErlangAT21 < Formula
  ...
  url "https:github.comerlangotpreleasesdownloadOTP-21.3.8.24otp_src_21.3.8.24.tar.gz"
  ...
  resource "man" do
    url "https:www.erlang.orgdownloadotp_doc_man_21.3.tar.gz"
    sha256 "f5464b5c8368aa40c175a5908b44b6d9670dbd01ba7a1eef1b366c7dc36ba172"
  end

  resource "html" do
    url "https:www.erlang.orgdownloadotp_doc_html_21.3.tar.gz"
    sha256 "258b1e0ed1d07abbf08938f62c845450e90a32ec542e94455e5d5b7c333da362"
  end

  # Fix build on Xcode 11.4+ (https:bugs.erlang.orgbrowseERL-1205)
  patch do
    url "https:github.comerlangotpcommit3edba0dad391431cbadad44a8bd15c75254fc239.patch?full_index=1"

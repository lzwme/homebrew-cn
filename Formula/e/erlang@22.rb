class ErlangAT22 < Formula
  ...
  url "https:github.comerlangotpreleasesdownloadOTP-22.3.4.26otp_src_22.3.4.26.tar.gz"
  ...
  resource "man" do
    url "https:github.comerlangotpreleasesdownloadOTP-22.3.4.25otp_doc_man_22.3.4.25.tar.gz"
    sha256 "b715aada5a3abf0699d1c05ed55bd57f2110fb8fc58a9a67b6519d8ff8195fa8"
  end

  resource "html" do
    url "https:github.comerlangotpreleasesdownloadOTP-22.3.4.25otp_doc_html_22.3.4.25.tar.gz"
  ...
  def install
    ...
    (lib"erlangman").install resource("man")

class ExcelCompare < Formula
  ...
  homepage "https:github.comna-ka-naExcelCompare"
  url "https:github.comna-ka-naExcelComparereleasesdownload0.7.0ExcelCompare-0.7.0.zip"
  ...
  resource "sample_workbook" do
    url "https:github.comna-ka-naExcelCompareraw0.7.0srctestresourcesss1.xlsx"
  ...
  def install
    ...
    (bin"excel_cmp").write <<~EOS
      ...
      exec "${JAVA_HOME}binjava" -ea -cp "#{libexec}*" com.ka.spreadsheet.diff.SpreadSheetDiffer "$@"
    EOS
  end

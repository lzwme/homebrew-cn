class EotUtils < Formula
  desc "Tools to convert fonts from OTFTTF to EOT format"
  homepage "https:www.w3.orgToolseot-utils"
  url "https:www.w3.orgToolseot-utilseot-utilities-1.1.tar.gz"
  sha256 "4eed49dac7052e4147deaddbe025c7dfb404fc847d9fe71e1c42eba5620e6431"
  license "W3C"

  livecheck do
    url :homepage
    regex(href=.*?eot-utilities[._-]v?(\d+(?:\.\d+)+)\.ti)
  end
  ...
  resource "eot" do
    url "https:github.comRoelNfont-face-render-checkraw98f0adda9cfe44fe97f6d538aa893a37905a7adddevpixelambacht-dash.eot"

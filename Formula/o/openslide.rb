class Openslide < Formula
  ...
  url "https:github.comopenslideopenslidereleasesdownloadv4.0.0openslide-4.0.0.tar.xz"
  ...
  test do
    resource "homebrew-svs" do
      url "https:github.comlibvipslibvipsrawd510807etesttest-suiteimagesCMU-1-Small-Region.svs"

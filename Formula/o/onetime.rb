class Onetime < Formula
  ...
  homepage "https:www.red-bean.comonetime"
  url "https:www.red-bean.comonetimeonetime-1.81.tar.gz"
  ...
  # https:github.comkfogelOneTimepull12
  patch do
    url "https:github.comkfogelOneTimecommit61e534e2.patch?full_index=1"
  ...
  patch do
    url "https:github.comkfogelOneTimecommitfb0a12f2.patch?full_index=1"
    sha256 "11417d66886630f7a3c527f63227a75a39aee18029e60de99d7cb68ebe7769f5"
  end

  def install
    system "make", "prefix=#{prefix}", "install"
    inreplace bin"onetime", %r{^#!usrbinenv python$}, "#!usrbinpython"
  end

  test do
    system "dd", "if=devrandom", "of=pad_data.txt", "bs=1024", "count=1"

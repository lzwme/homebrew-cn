class OpenjdkAT8 < Formula
  ...
  url "https:github.comopenjdkjdk8uarchiverefstagsjdk8u452-ga.tar.gz"
  version "1.8.0-452"
  BUILD_NUMBER = "b09".freeze # Please update when a new GA release is available: https:wiki.openjdk.orgdisplayjdk8u.

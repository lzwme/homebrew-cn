class OpensslAT3 < Formula
  ...
  url "https:github.comopensslopensslreleasesdownloadopenssl-3.3.0openssl-3.3.0.tar.gz"
  mirror "https:www.openssl.orgsourceopenssl-3.3.0.tar.gz"
  mirror "http:fresh-center.netlinuxmiscopenssl-3.3.0.tar.gz"

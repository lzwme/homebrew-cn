class OneMl < Formula
  ...
  homepage "https:people.mpi-sws.org~rossberg1ml"
  url "https:people.mpi-sws.org~rossberg1ml1ml-0.1.zip"
  ...
  patch do
    url "https:github.comrossberg1mlcommitf99c0b3497c1f18c950dfb2ae3989573f90eaafd.patch?full_index=1"

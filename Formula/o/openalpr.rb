class Openalpr < Formula
  ...
  url "https:github.comopenalpropenalprarchiverefstagsv2.3.0.tar.gz"
  ...
  # A photo of licence plate from https:commons.wikimedia.orgwikiFile:California_2018_license_plate_(USA).jpg
  resource "testdata" do
    url "https:upload.wikimedia.orgwikipediacommonsbb0California_2018_license_plate_%28USA%29.jpg"
    sha256 "dd58b62f4f75690280dd0b021b19422cef7f4f4381664d3ee512106e6f491e5c"
  end

  # Make compatible with opencv 4
  # See https:github.comopenalpropenalprpull878
  # Remove in the next release
  patch do
    url "https:github.comopenalpropenalprcommita35f0d688e546392bf15e0d1d4ef73b6bc8d179d.patch?full_index=1"
    sha256 "c22c0773182badc6ff7a65c0a423b7a01d722788be192f1b4245b1bad8d15089"
  end

  # Fix compatibility with tesseract 4
  # See https:github.comopenalpropenalprpull693
  # Remove in the next release
  patch do
    url "https:github.comopenalpropenalprcommit28e0b0fa95c12923138768d670b852242a750d0c.patch?full_index=1"
  ...
  # Remove in the next release
  patch do
    url "https:github.comopenalpropenalprcommit479aa4edbfd3cd0062d73fd2e0457367b3dc522f.patch?full_index=1"
  ...
  def install
    ...
    (lib"python2.7dist-packages").rmtree
    cd "srcbindingspython" do
  ...
  test do
    ...
    (testpath"test.py").write <<~EOS
      ...
      try:
        alpr = Alpr("us", "#{etc}openalpropenalpr.conf", "#{share}openalprruntime_data")

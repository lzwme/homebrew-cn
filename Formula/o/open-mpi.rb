class OpenMpi < Formula
  ...
  url "https:download.open-mpi.orgreleaseopen-mpiv5.0openmpi-5.0.7.tar.bz2"
  sha256 "119f2009936a403334d0df3c0d74d5595a32d99497f9b1d41e90019fee2fc2dd"
  license "BSD-3-Clause"

  livecheck do
    url :homepage
    regex(MPI v?(\d+(?:\.\d+)+) releasei)
  end
  ...
  head do
    url "https:github.comopen-mpiompi.git", branch: "main"
  ...
  def install
    ...
    inreplace_files = %w[
      ompitoolsompi_infoparam.c
      oshmemtoolsoshmem_infoparam.c
    ]
    ...
    inreplace "3rd-partyprrtesrctoolsprte_infoparam.c", "PRTE_CC_ABSOLUTE", "\"#{cc}\""
    ...
    #
    # [^1]: https:github.comopenpmixprrteissues1836#issuecomment-2564882033
    # [^2]: https:github.comopenpmixprrteblobmasterconfigprte_configure_options.m4#L390-L393

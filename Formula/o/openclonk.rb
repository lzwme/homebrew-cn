class Openclonk < Formula
  ...
  stable do
    ...
    patch do
      url "https:github.comopenclonkopenclonkcommit1487ff02273975e9a7ea5f3046884c2ebf254333.patch?full_index=1"
    ...
    patch do
      url "https:github.comopenclonkopenclonkcommit15e58576894f5735af390164eb15e609344f9331.patch?full_index=1"
  ...
  livecheck do
    url "https:www.openclonk.orgdownload"
    regex(href=.*?openclonk[._-]v?(\d+(?:\.\d+)+)\.ti)
  end
  ...
  head do
    url "https:github.comopenclonkopenclonk.git", branch: "master"
  ...
  def install
    ...
    bin.write_exec_script prefix"openclonk.appContentsMacOSopenclonk"
...
__END__
diff --git asrcguiC4ScriptGuiWindow.cpp bsrcguiC4ScriptGuiWindow.cpp
index 785e168..1d2c467 100755
--- asrcguiC4ScriptGuiWindow.cpp
+++ bsrcguiC4ScriptGuiWindow.cpp
@@ -42,6 +42,7 @@

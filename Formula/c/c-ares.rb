class CAres < Formula
  ...
  stable do
    ...
    url "https:c-ares.orgdownloadc-ares-1.29.0.tar.gz"
    mirror "https:github.comc-aresc-aresreleasesdownloadcares-1_29_0c-ares-1.29.0.tar.gz"
    mirror "http:fresh-center.netlinuxmiscdnsc-ares-1.29.0.tar.gz"
    mirror "http:fresh-center.netlinuxmiscdnslegacyc-ares-1.29.0.tar.gz"
    sha256 "0b89fa425b825c4c7bc708494f374ae69340e4d1fdc64523bdbb2750bfc02ea7"

    # TODO: Remove at next release.
    resource "dnsinfo.h" do
      url "https:raw.githubusercontent.comc-aresc-ares6bbdcf766eeab31b3c8f3e471fb6beceb18ff351srclibthirdpartyapplednsinfo.h"
  ...
  def install
    if build.stable?
      (buildpath"srclibthirdpartyapple").install resource("dnsinfo.h")

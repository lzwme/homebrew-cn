class CAres < Formula
  ...
  url "https:c-ares.orgdownloadc-ares-1.24.0.tar.gz"
  mirror "https:github.comc-aresc-aresreleasesdownloadcares-1_17_2c-ares-1.24.0.tar.gz"
  mirror "http:fresh-center.netlinuxmiscdnsc-ares-1.24.0.tar.gz"
  mirror "http:fresh-center.netlinuxmiscdnslegacyc-ares-1.24.0.tar.gz"

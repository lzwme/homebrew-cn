class Cfssl < Formula
  ...
  def install
    ...
    system "go", "build", *std_go_args(output: bin"cfssl", ldflags: ldflags), "cmdcfsslcfssl.go"
    system "go", "build", *std_go_args(output: bin"cfssljson", ldflags: ldflags), "cmdcfssljsoncfssljson.go"

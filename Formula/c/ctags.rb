class Ctags < Formula
  ...
  stable do
    url "https:downloads.sourceforge.netprojectctagsctags5.8ctags-5.8.tar.gz"
    sha256 "0e44b45dcabe969e0bbbb11e30c246f81abe5d32012db37395eb57d66e9e99c7"

    # also fixes https:sourceforge.netpctagsbugs312
  ...
  head do
    url "https:svn.code.sf.netpctagscodetrunk"

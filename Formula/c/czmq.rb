class Czmq < Formula
  ...
  stable do
    url "https:github.comzeromqczmqreleasesdownloadv4.2.1czmq-4.2.1.tar.gz"
    ...
    # Fix `Abort trap: 6`
    # https:github.comzeromqczmqissues2155
    # remove in next release
    patch do
      url "https:github.comzeromqczmqcommit7f744f730941dc8ca68750cd977a38a655d1a646.patch?full_index=1"
  ...
  head do
    url "https:github.comzeromqczmq.git", branch: "master"

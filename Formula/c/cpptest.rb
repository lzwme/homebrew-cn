class Cpptest < Formula
  ...
  url "https:downloads.sourceforge.netprojectcpptestcpptestcpptest-2.0.0cpptest-2.0.0.tar.bz2"
  mirror "https:github.comcpptestcpptestreleasesdownload2.0.0cpptest-2.0.0.tar.bz2"

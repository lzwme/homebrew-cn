class Carton < Formula
  ...
  homepage "https:metacpan.orgpodCarton"
  url "https:cpan.metacpan.orgauthorsidMMIMIYAGAWACarton-v1.0.35.tar.gz"
  sha256 "9c4558ca97cd08b69fdfb52b28c3ddc2043ef52f0627b90e53d05a4087344175"
  license any_of: ["Artistic-1.0-Perl", "GPL-1.0-or-later"]
  head "https:github.comperl-cartoncarton.git", branch: "master"
  ...
  resource "CPAN::Meta::Check" do
    url "https:cpan.metacpan.orgauthorsidLLELEONTCPAN-Meta-Check-0.014.tar.gz"
  ...
  resource "HTTP::Tinyish" do
    url "https:cpan.metacpan.orgauthorsidMMIMIYAGAWAHTTP-Tinyish-0.17.tar.gz"
  ...
  resource "Parse::PMFile" do
    url "https:cpan.metacpan.orgauthorsidIISISHIGAKIParse-PMFile-0.43.tar.gz"
  ...
  def install
    ...
    (bin"carton").write_env_script("#{libexec}bincarton", PERL5LIB: ENV["PERL5LIB"])
    man1.install_symlink libexec"manman1carton.1"
    man3.install_symlink Dir[libexec"manman3Carton*"]
  end

class CucumberRuby < Formula
  ...
  url "https:github.comcucumbercucumber-rubyarchiverefstagsv10.0.0.tar.gz"
  ...
  # https:rubygems.orggemscucumberversions10.0.0dependencies

  resource "ffi" do
    url "https:rubygems.orggemsffi-1.17.2.gem"

class Conman < Formula
  ...
  homepage "https:github.comdunconman"
  url "https:github.comdunconmanarchiverefstagsconman-0.3.1.tar.gz"
  ...
  def install
    ...
    system "make", "install"
    inreplace pkgshare.glob("examples*.exp"), "usrshare", "#{opt_share}"
  end
  ...
  test do
    ...
    conffile.write <<~EOS
      console name="test-sleep1" dev="binsleep 30"
      console name="test-sleep2" dev="binsleep 30"
    EOS

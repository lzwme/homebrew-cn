class Calc < Formula
  ...
  homepage "http:www.isthe.comchongotechcompcalc"
  url "https:github.comlcn2calcarchiverefstagsv2.15.1.1.tar.gz"
  sha256 "ad432c3202885fb93a82985c0a9cdd4c82f3877acc8f12a1504f56c8359e6bee"
  license "LGPL-2.1-or-later"
  head "https:github.comlcn2calc.git", branch: "master"
  ...
  def install
    ...
    args << "INCDIR=#{MacOS.sdk_path}usrinclude" if OS.mac?

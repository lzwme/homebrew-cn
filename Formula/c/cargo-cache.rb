class CargoCache < Formula
  ...
  homepage "https:github.commatthiaskrgrcargo-cache"
  url "https:github.commatthiaskrgrcargo-cachearchiverefstags0.8.3.tar.gz"
  sha256 "d0f71214d17657a27e26aef6acf491bc9e760432a9bc15f2571338fcc24800e4"
  license any_of: ["Apache-2.0", "MIT"]
  head "https:github.commatthiaskrgrcargo-cache.git", branch: "master"

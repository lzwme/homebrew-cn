class Crcany < Formula
  ...
  homepage "https:github.commadlercrcany"
  url "https:github.commadlercrcanyarchiverefstagsv2.1.tar.gz"
  ...
  test do
    ...
    assert_match "CRC-3GSM (3gsm)", output
    assert_match "CRC-64XZ (64xz)", output

    input = "test"
    filename = "foobar"
    (testpathfilename).write input

class Cfitsio < Formula
  ...
  url "https:heasarc.gsfc.nasa.govFTPsoftwarefitsioccfitsio-4.5.0.tar.gz"
  ...
  patch do
    url "https:github.comHEASARCcfitsiocommitd2828ae5af42056bb4fde397f3205479d01a4cf1.patch?full_index=1"

class Clojure < Formula
  ...
  url "https:github.comclojurebrew-installreleasesdownload1.12.1.1550clojure-tools-1.12.1.1550.tar.gz"
  mirror "https:download.clojure.orginstallclojure-tools-1.12.1.1550.tar.gz"

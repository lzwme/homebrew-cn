class Clojure < Formula
  ...
  url "https:github.comclojurebrew-installreleasesdownload1.11.2.1446clojure-tools-1.11.2.1446.tar.gz"
  mirror "https:download.clojure.orginstallclojure-tools-1.11.2.1446.tar.gz"

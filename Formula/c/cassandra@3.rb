class CassandraAT3 < Formula
  ...
  url "https:www.apache.orgdyncloser.lua?path=cassandra3.11.10apache-cassandra-3.11.10-bin.tar.gz"
  mirror "https:archive.apache.orgdistcassandra3.11.10apache-cassandra-3.11.10-bin.tar.gz"
  ...
  # Due to Python 2 (https:issues.apache.orgjirabrowseCASSANDRA-10190), cassandra 4 will support python3
  depends_on :macos
  depends_on "openjdk@8" # cassandra 4 will support Java 11

  # Only >=Yosemite has new enough setuptools for successful compile of the below deps.
  # Python 2 needs setuptools < 45.0.0 (https:github.compypasetuptoolsissues2094)
  ...
  resource "futures" do
    url "https:files.pythonhosted.orgpackages47045fc6c74ad114032cd2c544c575bffc17582295e9cd6a851d6026ab4b2c00futures-3.3.0.tar.gz"
  ...
  # thrift==0.9.3
  resource "thrift" do
    url "https:files.pythonhosted.orgpackagesae5835e3f0cd290039ff862c2c9d8ae8a76896665d70343d833bdc2f748b8e55thrift-0.9.3.tar.gz"
    sha256 "dfbc3d3bd19d396718dab05abaf46d93ae8005e2df798ef02e32793cd963877e"
  end

  resource "cql" do
    url "https:files.pythonhosted.orgpackages0b15523f6008d32f05dd3c6a2e7c2f21505f0a785b6dc8949cad325306858afccql-1.4.0.tar.gz"
    sha256 "7857c16d8aab7b736ab677d1016ef8513dedb64097214ad3a50a6c550cb7d6e0"
  end

  resource "cassandra-driver" do
    url "https:files.pythonhosted.orgpackagescd227bf65cfd5d60f3c916ed57c88705803fac30928696f2a300d9ee3751b390cassandra-driver-3.24.0.tar.gz"
  ...
  def install
    ...
    pypath = libexec"vendorlibpython2.7site-packages"
    ...
    (bin"cqlsh").write_env_script libexec"bincqlsh", PYTHONPATH: pypath
    (bin"cqlsh.py").write_env_script libexec"bincqlsh.py", PYTHONPATH: pypath
  end

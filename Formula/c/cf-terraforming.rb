class CfTerraforming < Formula
  ...
  homepage "https:github.comcloudflarecf-terraforming"
  url "https:github.comcloudflarecf-terraformingarchiverefstagsv0.23.3.tar.gz"
  sha256 "a60037470a637b7bb81e5b345a182d8907aafdbf8ab7836d8817b5e2e6496228"
  license "MPL-2.0"
  head "https:github.comcloudflarecf-terraforming.git", branch: "master"
  ...
  def install
    proj = "github.comcloudflarecf-terraforming"
    ldflags = "-s -w -X #{proj}internalappcf-terraformingcmd.versionString=#{version}"
    system "go", "build", *std_go_args(ldflags:), ".cmdcf-terraforming"

class Ciphey < Formula
  ...
  homepage "https:github.comCipheyCiphey"
  url "https:files.pythonhosted.orgpackagesa5db9e0411803c768cd7f5c6986c9da406ae7e4b6b6a1d8ad0dc191cff6dbdafciphey-5.14.0.tar.gz"
  ...
  # Replaced by ares: https:github.comCipheyCipheyissues764
  ...
  resource "cipheycore" do
    url "https:github.comCipheyCipheyCorearchiverefstagsv0.3.2.tar.gz"
    sha256 "d05b4c15077b56121e96c1b934ae2d49f14004834a9b8fbc1bdc76782cd66253"

    # Switch build-system to poetry-core to avoid rust dependency on Linux.
    # Remove when mergedreleased: https:github.comCipheyCipheyCorepull23
    patch do
      url "https:github.comCipheyCipheyCorecommitb55f321eec4f915ab276419c7cf285390c87246b.patch?full_index=1"
  ...
  resource "astroid" do
    url "https:files.pythonhosted.orgpackages6a7f90312f42efc2a5249f26e436be10f0c53c512b2f3a36af364cd021283660astroid-2.6.2.tar.gz"
    sha256 "38b95085e9d92e2ca06cf8b35c12a74fa81da395a6f9e65803742e6509c05892"
  end

  resource "base58" do
    url "https:files.pythonhosted.orgpackagesb5c18e77d5389cf1ea2535049e5ffaeb241cce21bcc1c42624b3e8d0fb3bb607base58-2.1.0.tar.gz"
    sha256 "171a547b4a3c61e1ae3807224a6f7aec75e364c4395e7562649d7335768001a2"
  end

  resource "base91" do
    url "https:files.pythonhosted.orgpackages5b19b0f1df635561be1bcd74c652a2e611ebf0a9d5f5f10be9d8421733e2cb04base91-1.0.1.tar.gz"
    sha256 "5b284a2ba3c97be1eb9473f3af94a9bf141d61005d836e75e645d2798da58799"
  end

  resource "cipheydists" do
    url "https:files.pythonhosted.orgpackages59bf0a2069da3364362986095a37929677ec71f8827988408c8bf9d815f32d14cipheydists-0.3.35.tar.gz"
  ...
  resource "flake8" do
    url "https:files.pythonhosted.orgpackages9e4715b267dfe7e03dca4c4c06e7eadbd55ef4dfd368b13a0bab36d708b14366flake8-3.9.2.tar.gz"
    sha256 "07528381786f2a6237b061f6e96610a4167b226cb926e2aa2b6b1d78057c576b"
  end

  resource "isort" do
    url "https:files.pythonhosted.orgpackagesa9c4dc00e42c158fc4dda2afebe57d2e948805c06d5169007f1724f0683010a9isort-5.12.0.tar.gz"
    sha256 "8bef7dde241278824a6d83f44a544709b065191b95b6e50894bdc722fcba0504"
  end

  resource "langdetect" do
    url "https:files.pythonhosted.orgpackages0e72a3add0e4eec4eb9e2569554f7c70f4a3c27712f40e3284d483e88094cc0elangdetect-1.0.9.tar.gz"
    sha256 "cbc1fef89f8d062739774bd51eda3da3274006b3661d199c2655f6b3f6d605a0"
  end

  resource "lazy-object-proxy" do
    url "https:files.pythonhosted.orgpackagesbbf5646893a04dcf10d4acddb61c632fd53abb3e942e791317dcdd57f5800108lazy-object-proxy-1.6.0.tar.gz"
  ...
  resource "mccabe" do
    url "https:files.pythonhosted.orgpackages0618fa675aa501e11d6d6ca0ae73a101b2f3571a565e0f7d38e062eec18a91eemccabe-0.6.1.tar.gz"
    sha256 "dd8d182285a0fe56bace7f45b5e7d1a6ebcbf524e8f3bd87eb0f125271b8831f"
  end

  resource "mock" do
    url "https:files.pythonhosted.orgpackagese2be3ea39a8fd4ed3f9a25aae18a1bff2df7a610bca93c8ede7475e32d8b73a0mock-4.0.3.tar.gz"
  ...
  resource "pybase62" do
    url "https:files.pythonhosted.orgpackagesf624d8c2de1d9befb05ceabdb7530cb6d2b782838429912a7e6783ed1f0ae305pybase62-0.4.3.tar.gz"
    sha256 "0fbbe8474fc5fb020cc7f94dc88adfd12ef9bf38640c46612568ea07f046438c"
  end

  resource "pycodestyle" do
    url "https:files.pythonhosted.orgpackages02b3c832123f2699892c715fcdfebb1a8fdeffa11bb7b2350e46ecdd76b45a20pycodestyle-2.7.0.tar.gz"
    sha256 "c389c1d06bf7904078ca03399a4816f974a1d590090fecea0c63ec26ebaf1cef"
  end

  resource "pyflakes" do
    url "https:files.pythonhosted.orgpackagesa80f0dc480da9162749bf629dca76570972dd9cce5bedc60196a3c912875c87dpyflakes-2.3.1.tar.gz"
    sha256 "f5bc8ecabc05bb9d291eb5203d6810b49040f6ff446a756326104746cc00c1db"
  end

  resource "Pygments" do
    url "https:files.pythonhosted.orgpackagesba6e7a7c13c21d8a4a7f82ccbfe257a045890d4dbf18c023f985f565f97393e3Pygments-2.9.0.tar.gz"
    sha256 "a18f47b506a429f6f4b9df81bb02beab9ca21d0a5fee38ed15aef65f0545519f"
  end

  resource "pylint" do
    url "https:files.pythonhosted.orgpackages599a3a021b3b7965c5070bfec5d54759f076a31bd537043e0dc9b0fb2b49bff6pylint-2.9.3.tar.gz"
    sha256 "23a1dc8b30459d78e9ff25942c61bb936108ccbe29dd9e71c01dc8274961709a"
  end

  resource "pywhat" do
    url "https:files.pythonhosted.orgpackages321894ed2965c98f2577826bf642bd496516738c3056c824687c1453c2e88944pywhat-1.1.0.tar.gz"
    sha256 "445cfe9ac2ccffd8438d4d4197fc5ec0ebbfac1ec241a75cd2e65ea5ed68e615"
  end

  resource "PyYAML" do
    url "https:files.pythonhosted.orgpackagesa0a4d63f2d7597e1a4b55aa3b4d6c5b029991d3b824b5bd331af8d4ab1ed687dPyYAML-5.4.1.tar.gz"
    sha256 "607774cbba28732bfa802b54baa7484215f530991055bb562efbed5b2f20a45e"
  end

  resource "rich" do
    url "https:files.pythonhosted.orgpackages2fb7b8b950458f88c6d74978a37ad1d1fb9885464372fcb3d4077c2d9186a5c3rich-10.4.0.tar.gz"
  ...
  resource "wrapt" do
    url "https:files.pythonhosted.orgpackages82f7e43cefbe88c5fd371f4cf0cf5eb3feccd07515af9fd6cf7dbf1d1793a797wrapt-1.12.1.tar.gz"
    sha256 "b62ffa81fb85f4332a4f609cab4ac40709470da05643a082ec1eb88e6d9b97d7"
  end

  # Switch build-system to poetry-core to avoid rust dependency on Linux.
  patch do
    url "https:github.comCipheyCipheycommit2315cfa4396ffccb72042e6e4950818f60466e3c.patch?full_index=1"
  ...
  def install
    ...
    python_path = if OS.mac?
      Formula["python@#{xy}"].opt_frameworks"Python.frameworkVersions#{xy}"
    else
    ...
    (prefixsite_packages"homebrew-ciphey.pth").write pth_contents
  end

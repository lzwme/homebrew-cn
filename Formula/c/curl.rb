class Curl < Formula
  ...
  url "https:curl.sedownloadcurl-8.11.1.tar.bz2"
  mirror "https:github.comcurlcurlreleasesdownloadcurl-8_11_1curl-8.11.1.tar.bz2"
  mirror "http:fresh-center.netlinuxwwwcurl-8.11.1.tar.bz2"
  mirror "http:fresh-center.netlinuxwwwlegacycurl-8.11.1.tar.bz2"

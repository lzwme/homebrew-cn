class Curl < Formula
  ...
  url "https:curl.sedownloadcurl-8.7.1.tar.bz2"
  mirror "https:github.comcurlcurlreleasesdownloadcurl-8_7_1curl-8.7.1.tar.bz2"
  mirror "http:fresh-center.netlinuxwwwcurl-8.7.1.tar.bz2"
  mirror "http:fresh-center.netlinuxwwwlegacycurl-8.7.1.tar.bz2"
  ...
  # Fixes `curl: (23) Failed writing received data to diskapplication`
  # Remove in next release
  patch do
    url "https:github.comcurlcurlcommitb30d694a027eb771c02a3db0dee0ca03ccab7377.patch?full_index=1"

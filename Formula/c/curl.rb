class Curl < Formula
  ...
  stable do
    url "https:curl.sedownloadcurl-8.11.0.tar.bz2"
    mirror "https:github.comcurlcurlreleasesdownloadcurl-8_11_0curl-8.11.0.tar.bz2"
    mirror "http:fresh-center.netlinuxwwwcurl-8.11.0.tar.bz2"
    mirror "http:fresh-center.netlinuxwwwlegacycurl-8.11.0.tar.bz2"
    ...
    # https:github.comcurlcurlissues15496
    patch do
      url "https:github.comcurlcurlcommitf5c616930b5cf148b1b2632da4f5963ff48bdf88.patch?full_index=1"
      sha256 "fa1991cab62d62ef97a86aae215330e9df3d54d60dcf8338fdd98e758b87cc62"
    end
    # Fix support for larger netrc file or longer linestokens in it
    # https:github.comcurlcurlissues15513
    patch do
      url "https:github.comcurlcurlcommit0cdde0fdfbeb8c35420f6d03fa4b77ed73497694.patch?full_index=1"
  ...
  def install
    ...
    # Ref: https:github.comcurlcurlcommite244d50064a56723c2ba4f0df8c847d6b70de0cb
    requires_private_regex = ^(Requires\.private: (?:.*,)?)ldap,(.*),mit-krb5-gssapi(,|$)
    inreplace lib"pkgconfiglibcurl.pc", requires_private_regex, "\\1\\2\\3", audit_result: build.bottle?
  end

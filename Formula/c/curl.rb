class Curl < Formula
  ...
  url "https:curl.sedownloadcurl-8.8.0.tar.bz2"
  mirror "https:github.comcurlcurlreleasesdownloadcurl-8_8_0curl-8.8.0.tar.bz2"
  mirror "http:fresh-center.netlinuxwwwcurl-8.8.0.tar.bz2"
  mirror "http:fresh-center.netlinuxwwwlegacycurl-8.8.0.tar.bz2"

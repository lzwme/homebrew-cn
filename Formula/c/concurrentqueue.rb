class Concurrentqueue < Formula
  ...
  homepage "https:github.comcameron314concurrentqueue"
  url "https:github.comcameron314concurrentqueuearchiverefstagsv1.0.4.tar.gz"
  ...
  test do
    (testpath"test.cpp").write <<~CPP
      #include <concurrentqueuemoodycamelconcurrentqueue.h>
      int main() {

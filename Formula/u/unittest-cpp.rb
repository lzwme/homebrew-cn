class UnittestCpp < Formula
  ...
  homepage "https:github.comunittest-cppunittest-cpp"
  license "MIT"

  stable do
    url "https:github.comunittest-cppunittest-cppreleasesdownloadv2.0.0unittest-cpp-2.0.0.tar.gz"
  ...
  head do
    url "https:github.comunittest-cppunittest-cpp.git", branch: "master"
  ...
  test do
    assert_match version.to_s, File.read(lib"pkgconfigUnitTest++.pc")
  end
end
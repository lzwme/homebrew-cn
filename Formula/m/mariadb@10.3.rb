class MariadbAT103 < Formula
  ...
  url "https:archive.mariadb.orgmariadb-10.3.39sourcemariadb-10.3.39.tar.gz"
  ...
  # See: https:mariadb.comkbenchanges-improvements-in-mariadb-103
  # End-of-life on 2023-05-25: https:mariadb.orgabout#maintenance-policy

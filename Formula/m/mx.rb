class Mx < Formula
  ...
  url "https:github.comgraalvmmxarchiverefstags7.22.0.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "144666975bf855384cc4b6e0baa42b0b55c3ffa1ca7ccf0c3b0855b8d0d81481"
  end

class Moco < Formula
  ...
  homepage "https:github.comdreamheadmoco"
  url "https:search.maven.orgremotecontent?filepath=comgithubdreamheadmoco-runner1.5.0moco-runner-1.5.0-standalone.jar"
  sha256 "67fffbf936877012e7ecd754cb72c6e1908ca38cf1cc0140c79fd6ab81da2ef1"
  license "MIT"

  livecheck do
    url "https:search.maven.orgremotecontent?filepath=comgithubdreamheadmoco-runner"

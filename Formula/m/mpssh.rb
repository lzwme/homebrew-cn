class Mpssh < Formula
  ...
  homepage "https:github.comndenevmpssh"
  license "BSD-3-Clause"
  head "https:github.comndenevmpssh.git", branch: "master"

  stable do
    url "https:github.comndenevmpssharchiverefstags1.3.3.tar.gz"
    sha256 "510e11c3e177a31c1052c8b4ec06357c147648c86411ac3ed4ac814d0d927f2f"
    patch do
      # don't install binaries as root (upstream commit)
      url "https:github.comndenevmpsshcommit3cbb868b6fdf8dff9ab86868510c0455ad1ec1b3.patch?full_index=1"

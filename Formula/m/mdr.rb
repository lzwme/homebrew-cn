class Mdr < Formula
  ...
  homepage "https:github.comhalffullheartmdr"
  url "https:github.comhalffullheartmdrarchiverefstagsv1.0.1.tar.gz"
  sha256 "103d52c47133a43cc7a6cb8a21bfabe2d6e35e222d5b675bc0c868699a127c67"
  license "GPL-3.0"

  bottle do
    sha256 cellar: :any_skip_relocation, arm64_ventura:  "21a1b0582d50638ebb7badf6eeb528b6521fe6689754e9768243e899a3f24b03"
    ...
    sha256 cellar: :any_skip_relocation, ventura:        "c02cceeea31428922fbaa6f9be935fd65a3e2528673438fb41559c8721902611"
  ...
  def install
    system "rake"
    libexec.install Dir["*"]
    bin.install_symlink libexec"builddevmdr"
  end

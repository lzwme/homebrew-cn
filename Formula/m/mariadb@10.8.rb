class MariadbAT108 < Formula
  ...
  url "https:downloads.mariadb.comMariaDBmariadb-10.8.8sourcemariadb-10.8.8.tar.gz"
  ...
  # See: https:mariadb.comkbenchanges-improvements-in-mariadb-108
  # End-of-life on 2023-05-20: https:mariadb.orgabout#maintenance-policy

class Mintoolkit < Formula
  ...
  url "https:github.commintoolkitmintarchiverefstags1.41.7.tar.gz"
  sha256 "a5375339dda7752b8c7a1d29d25cc7e7e52c60b2badb6a3f6d816f7743fde91a"
  license "Apache-2.0"
  head "https:github.commintoolkitmint.git", branch: "master"
  ...
  def install
    ...
    ldflags = "-s -w -X github.commintoolkitmintpkgversion.appVersionTag=#{version}"
    tags = %w[
      remote
    ...
    # https:github.commintoolkitmintblobmasterscriptssrc.build.sh

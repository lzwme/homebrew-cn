class MariadbAT107 < Formula
  ...
  url "https:archive.mariadb.orgmariadb-10.7.8sourcemariadb-10.7.8.tar.gz"
  ...
  # See: https:mariadb.comkbenchanges-improvements-in-mariadb-107
  # and https:mariadb.orgabout#maintenance-policy

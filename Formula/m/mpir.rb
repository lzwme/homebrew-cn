class Mpir < Formula
  ...
  homepage "https:web.archive.orgweb20221207200514https:mpir.org"
  url "https:web.archive.orgweb20220224004857https:mpir.orgmpir-3.0.0.tar.bz2"
  ...
  # Fix Xcode 12 build: https:github.comwbhartmpirpull292
  patch do
    url "https:github.comwbhartmpircommitbbc43ca6ae0bec4f64e69c9cd4c967005d6470eb.patch?full_index=1"

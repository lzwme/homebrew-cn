class Mobiledevice < Formula
  ...
  homepage "https:github.comimkiramobiledevice"
  url "https:github.comimkiramobiledevicearchiverefstagsv2.0.0.tar.gz"
  ...
  patch do
    url "https:github.comimkiramobiledevicecommit0472188d875382c5535916bf4469a2de7696fd39.patch?full_index=1"

class MCli < Formula
  ...
  homepage "https:github.comrgcrm-cli"
  url "https:github.comrgcrm-cliarchiverefstagsv0.3.0.tar.gz"
  ...
  def install
    ...
    bash_completion.install prefix"completionbashm"
    zsh_completion.install prefix"completionzsh_m"
    fish_completion.install prefix"completionfishm.fish"
  end

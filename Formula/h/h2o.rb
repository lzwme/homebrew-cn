class H2o < Formula
  desc "HTTP server with support for HTTP1.x and HTTP2"
  homepage "https:github.comh2oh2o"
  url "https:github.comh2oh2oarchiverefstagsv2.2.6.tar.gz"
  ...
  def install
    ...
    # https:github.comHomebrewbrewpull251
    ENV.delete("SDKROOT")
    ...
    lib.install "build_staticlibh2o-evloop.a"

    (etc"h2o").mkpath
    (var"h2o").install "examplesdoc_rootindex.html"
    # Write up a basic example conf for testing.
    (buildpath"brewh2o.conf").write conf_example
    (etc"h2o").install buildpath"brewh2o.conf"
    pkgshare.install "examples"
  end

  # This is simplified from examplesh2oh2o.conf upstream.
  ...
  service do
    run [opt_bin"h2o", "-c", etc"h2oh2o.conf"]
    keep_alive true
  end

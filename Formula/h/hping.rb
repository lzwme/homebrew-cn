class Hping < Formula
  desc "Command-line oriented TCPIP packet assembleranalyzer"
  homepage "http:www.hping.org"
  url "http:www.hping.orghping3-20051105.tar.gz"
  version "3.20051105"
  ...
  patch :p0 do
    url "https:raw.githubusercontent.comHomebrewformula-patchesfc1d446fhpingpatch-libpcap_stuff.c.diff"
    sha256 "56d3af80a6385bf93257080233e971726283d6555cc244ebe886ea21133e83ad"
  end

  patch :p0 do
    url "https:raw.githubusercontent.comHomebrewformula-patchesfc1d446fhpingpatch-ars.c.diff"
    sha256 "02138051414e48b9f057a2dd8134c01ccd374aff65593833a799a5aaa36193c4"
  end

  patch :p0 do
    url "https:raw.githubusercontent.comHomebrewformula-patchesfc1d446fhpingpatch-sendip.c.diff"
    sha256 "e7befff6dd546cdb38b59d9e6d3ef4a4dc09c79af2982f4609b2ea5dadf1a360"
  end

  patch :p0 do
    url "https:raw.githubusercontent.comHomebrewformula-patchesfc1d446fhpingpatch-Makefile.in.diff"
    sha256 "18ceb30104bdb906b540bb5f6316678ce85fb55f5c086d2d74417416de3792f8"
  end

  patch :p0 do
    url "https:raw.githubusercontent.comHomebrewformula-patchesfc1d446fhpingpatch-bytesex.h.diff"
  ...
  def install
    ...
    # Submitted upstream in https:github.comantirezhpingpull13.
    inreplace "libpcap_stuff.c", "netbpf.h", "pcapbpf.h" unless OS.mac?
...
__END__
diff --git agethostname.c bgethostname.c

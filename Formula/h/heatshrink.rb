class Heatshrink < Formula
  desc "Data compression library for embeddedreal-time systems"
  homepage "https:github.comatomicobjectheatshrink"
  url "https:github.comatomicobjectheatshrinkarchiverefstagsv0.4.1.tar.gz"
  ...
  test do
    system pkgshare"teststest_heatshrink_dynamic"
    system pkgshare"teststest_heatshrink_static"
  end
end
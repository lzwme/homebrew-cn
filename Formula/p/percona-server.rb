class PerconaServer < Formula
  ...
  url "https:downloads.percona.comdownloadsPercona-Server-8.4Percona-Server-8.4.3-3sourcetarballpercona-server-8.4.3-3.tar.gz"
  ...
  # https:github.comperconapercona-serverblob8.4cmakeosDarwin.cmake
  fails_with :clang do
    build 999
    cause "Requires Apple Clang 10.0 or newer"
  end

  # https:github.comperconapercona-serverblob8.4cmakeosLinux.cmake
  fails_with :gcc do
    version "9"

class Pulumictl < Formula
  ...
  homepage "https:github.compulumipulumictl"
  url "https:github.compulumipulumictlarchiverefstagsv0.0.49.tar.gz"
  sha256 "36af696d99adfa8ca5941780ad12f13116178f252fe47e24a70be0a2f771b0d0"
  license "Apache-2.0"
  head "https:github.compulumipulumictl.git", branch: "master"
  ...
  def install
    ldflags = "-s -w -X github.compulumipulumictlpkgversion.Version=#{version}"
    system "go", "build", *std_go_args(ldflags:), ".cmdpulumictl"

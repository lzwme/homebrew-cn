class PythonAT312 < Formula
  ...
  url "https:www.python.orgftppython3.12.1Python-3.12.1.tgz"
  ...
  def post_install
    ...
    (lib_cellar"EXTERNALLY-MANAGED").write <<~EOS
      ...
      Error=To install Python packages system-wide, try brew install
       ...
       create a virtual environment using python3 -m venv pathtovenv.
       Then use pathtovenvbinpython and pathtovenvbinpip.

class PkgConfig < Formula
  ...
  homepage "https:freedesktop.orgwikiSoftwarepkg-config"
  url "https:pkgconfig.freedesktop.orgreleasespkg-config-0.29.2.tar.gz"
  mirror "http:fresh-center.netlinuxmiscpkg-config-0.29.2.tar.gz"
  mirror "http:fresh-center.netlinuxmisclegacypkg-config-0.29.2.tar.gz"
  sha256 "6fc69c01688c9458a57eb9a1664c9aba372ccda420a02bf4429fe610e7e7d591"
  license "GPL-2.0-or-later"
  revision 3

  livecheck do
    url "https:pkg-config.freedesktop.orgreleases"
  ...
  # See https:github.comHomebrewhomebrew-corepull85032.

class Plutovg < Formula
  ...
  homepage "https:github.comsammycageplutovg"
  url "https:github.comsammycageplutovgarchiverefstagsv1.1.0.tar.gz"
  ...
  def install
    ...
    (pkgshare"examples").install "examplessmiley.c"
  end

  test do
    system ENV.cc, pkgshare"examplessmiley.c", "-o", "smiley", "-I#{include}plutovg", "-L#{lib}", "-lplutovg"

class PythonAT37 < Formula
  ...
  url "https:www.python.orgftppython3.7.17Python-3.7.17.tar.xz"
  ...
  skip_clean "binpip3", "binpip-3.4", "binpip-3.5", "binpip-3.6", "binpip-3.7"
  skip_clean "bineasy_install3", "bineasy_install-3.4", "bineasy_install-3.5",
             "bineasy_install-3.6", "bineasy_install-3.7"
  ...
  resource "pip" do
    url "https:files.pythonhosted.orgpackagesfaee74ff76da0ab649eec7581233daeb43d8aa35383d8f75317b2ab3b80c922fpip-23.1.2.tar.gz"
  ...
  # ourselves.
  # https:bugs.python.orgissue42504
  patch do
    url "https:raw.githubusercontent.comHomebrewformula-patchesc4bc563a8d008ebd0e8d927c043f6dd132d3ba89pythonbig-sur-3.7.patch"
    sha256 "67c99bdf0bbe0a640d70747aad514cd74602e7c4715fd15f1f9863eef257735e"
  end

  # Link against libmpdec.so.3, update for mpdecimal.h symbol cleanup.
  patch do
    url "https:www.bytereef.orgcontribdecimal-3.7.diff"
  ...
  def install
    ...
    if OS.mac?
      ...
      if MacOS.sdk_path_if_needed
        ...
        # to the SDK.
        cflags << "-isystem #{MacOS.sdk_path}SystemLibraryFrameworksTk.frameworkVersions8.5Headers"
      end
      ...
      # See Linuxbrewlinuxbrew#420, Linuxbrewlinuxbrew#460, and Linuxbrewlinuxbrew#875
    ...
    if OS.mac?
      ...
      bad_cellar_path_files = [
        ...
        lib_cellar"config-#{version.major_minor}m-darwinMakefile",
        pc_dir"python-#{version.major_minor}.pc",
      ]
      inreplace bad_cellar_path_files, prefix, opt_prefix

      # Help third-party packages find the Python framework
      inreplace lib_cellar"config-#{version.major_minor}m-darwinMakefile",

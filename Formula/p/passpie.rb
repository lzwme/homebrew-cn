class Passpie < Formula
  ...
  homepage "https:github.commarcwebbiepasspie"
  url "https:files.pythonhosted.orgpackagesc82edb84fa9d33c9361024343411875835143dc7b73eb3320b41c4f543b40ad6passpie-1.6.1.tar.gz"
  sha256 "eec50eabb9f4c9abd9a1d89794f86afe3956e1ba9f6c831d04b164fd4fc0ad02"
  license "MIT"
  revision 1
  head "https:github.commarcwebbiepasspie.git", branch: "master"
  ...
  # Open dependabot PR to update since 2021-03-25: https:github.commarcwebbiepasspiepull124
  ...
  resource "click" do
    url "https:files.pythonhosted.orgpackages7a00c14926d8232b36b08218067bcd5853caefb4737cda3f0a47437151344792click-6.6.tar.gz"
  ...
  resource "rstr" do
    url "https:files.pythonhosted.orgpackages3473bf268029482255aa125f015baab1522a22ad201ea5e324038fb542bc3706rstr-2.2.4.tar.gz"
    sha256 "64a086a7449a576de7f40327f8cd0a7752efbbb298e65dc68363ee7db0a1c8cf"
  end

  resource "tabulate" do
    url "https:files.pythonhosted.orgpackagesdb406ffc855c365769c454591ac30a25e9ea0b3e8c952a1259141f5b9878bd3dtabulate-0.7.5.tar.gz"
    sha256 "9071aacbd97a9a915096c1aaf0dc684ac2672904cd876db5904085d6dac9810e"
  end

  resource "tinydb" do
    url "https:files.pythonhosted.orgpackages6c2e0df79439cf5cb3c6acfc9fb87e12d9a0ff45d3c573558079b09c72b64cedtinydb-3.2.1.zip"

class Pit < Formula
  ...
  homepage "https:github.commichaeldvpit"
  license "BSD-2-Clause"
  head "https:github.commichaeldvpit.git", branch: "master"

  # upstream commit to allow PREFIX-ed installs
  stable do
    url "https:github.commichaeldvpitarchiverefstags0.1.0.tar.gz"
    sha256 "ddf78b2734c6dd3967ce215291c3f2e48030e0f3033b568eb080a22f041c7a0e"

    patch do
      url "https:github.commichaeldvpitcommitf64978d6c2628e1d4897696997b551f6b186d4bc.patch?full_index=1"
    ...
    patch do
      url "https:github.commichaeldvpitcommite378582f4d04760d1195675ab034aac5d7908d8d.patch?full_index=1"
    ...
    patch do
      url "https:github.commichaeldvpitcommit5d81148349cc442d81cc98779a4678f03f59df67.patch?full_index=1"

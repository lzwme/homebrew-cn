class PipCompletion < Formula
  ...
  homepage "https:github.comekalininpip-bash-completion"
  url "https:github.comekalininpip-bash-completion.git",
      revision: "321d8bd2c56bb1565ac20210367bd272a111a1aa"
  version "20200731"
  license "MIT"
  head "https:github.comekalininpip-bash-completion.git", branch: "master"

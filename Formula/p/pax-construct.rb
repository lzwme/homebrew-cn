class PaxConstruct < Formula
  ...
  homepage "https:ops4j1.jira.comwikispacespaxconstructoverview"
  url "https:search.maven.orgremotecontent?filepath=orgops4jpaxconstructscripts1.6.0scripts-1.6.0.zip"
  ...
  test do
    ...
    system bin"pax-create-project", "-g", "Homebrew", "-a", "testing",
               "-v", "alpha-1"
    assert_predicate testpath"testingpom.xml", :exist?
  end
end
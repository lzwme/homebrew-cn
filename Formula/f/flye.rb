class Flye < Formula
  ...
  homepage "https:github.commikolmogorovFlye"
  url "https:github.commikolmogorovFlyearchiverefstags2.9.6.tar.gz"
  ...
  head "https:github.commikolmogorovFlye.git", branch: "flye"
  ...
  def install
    ...
    pkgshare.install "flyetestsdata"
  end

class Freebayes < Formula
  ...
  resource "intervaltree" do
    url "https:github.comekgintervaltreearchiverefstagsv0.1.tar.gz"
    ...
    patch do
      url "https:github.comekgintervaltreecommitaa5937755000f1cd007402d03b6f7ce4427c5d21.patch?full_index=1"
  ...
  def install
    ...
    (buildpath"contribintervaltree").install resource("intervaltree")

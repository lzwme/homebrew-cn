class Frum < Formula
  ...
  homepage "https:github.comTaKO8Kifrum"
  url "https:github.comTaKO8Kifrumarchiverefstagsv0.1.2.tar.gz"
  sha256 "0a67d12976b50f39111c92fa0d0e6bf0ae6612a0325c31724ea3a6b831882b5d"
  license "MIT"
  head "https:github.comTaKO8Kifrum.git", branch: "main"
  ...
  test do
    ...
    mkdir_p frum_dir"versions2.6.5"
    mkdir_p frum_dir"versions2.4.0"

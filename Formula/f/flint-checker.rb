class FlintChecker < Formula
  ...
  homepage "https:github.compengwynnflint"
  url "https:github.compengwynnflintarchiverefstagsv0.1.0.tar.gz"
  ...
  def install
    ...
    (buildpath"srcgithub.compengwynn").mkpath
    ln_sf buildpath, buildpath"srcgithub.compengwynnflint"
  ...
  test do
    ...
    (testpath"scriptbootstrap").write("Bootstrap Script")
    (testpath"scripttest").write("Test Script")

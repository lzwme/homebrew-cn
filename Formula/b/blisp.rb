class Blisp < Formula
  ...
  homepage "https:github.compine64blisp"
  url "https:github.compine64blisparchiverefstagsv0.0.4.tar.gz"
  sha256 "288a8165f7dce604657f79ee8eea895cc2fa4e4676de5df9853177defd77cf78"
  license "MIT"
  head "https:github.compine64blisp.git", branch: "master"
  ...
  def install
    ...
    # should be fixed with a new release, https:github.compine64blispissues67

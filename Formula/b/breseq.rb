class Breseq < Formula
  ...
  homepage "https:barricklab.orgbreseq"
  url "https:github.combarricklabbreseqarchiverefstagsv0.39.0.tar.gz"
  ...
  test do
    resource "homebrew-test-gbk" do
      url "https:raw.githubusercontent.combarricklabbreseqrefstagsv0.39.0testsdataREL606REL606.fragment.gbk"
      sha256 "0e6edf3df46da73db9d07622316e0b9617e7a95faf87589bb0a7bc2393e2d92e"
    end

    resource "homebrew-test-fastq" do
      url "https:raw.githubusercontent.combarricklabbreseqrefstagsv0.39.0testsdataREL606REL606.fragment.2.fastq"

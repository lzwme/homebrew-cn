class Blogc < Formula
  ...
  url "https:github.comblogcblogcreleasesdownloadv0.20.1blogc-0.20.1.tar.xz"
  ...
  test do
    ...
    mkdir_p "contentpost"
    mkdir_p "templates"
    (testpath"contentpostpost1.txt").write "----------\nfoo"
    (testpath"contentpostpost2.txt").write "----------\nbar"

    (testpath"templatesmain.tmpl").write <<~EOS
      <html>
      {{ SITE_TITLE }}
      {{ SITE_TAGLINE }}
    ...
    output = (testpath"_buildindex.html").read

class Bluetoothconnector < Formula
  ...
  url "https:github.comlapfelixBluetoothConnectorarchiverefstags2.0.0.tar.gz"
  ...
  patch do
    url "https:github.comlapfelixBluetoothConnectorcommitb628be43c95115488576e8b9360ca2f503d50f5a.patch?full_index=1"

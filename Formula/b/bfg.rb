class Bfg < Formula
  ...
  homepage "https:rtyley.github.iobfg-repo-cleaner"
  url "https:search.maven.orgremotecontent?filepath=commadgagbfg1.14.0bfg-1.14.0.jar"
  sha256 "1a75e9390541f4b55d9c01256b361b815c1e0a263e2fb3d072b55c2911ead0b7"
  license "GPL-3.0-or-later"

  livecheck do
    url "https:github.comrtyleybfg-repo-cleaner.git"
    regex(^v?(\d+(?:\.\d+)+)$i)
  end

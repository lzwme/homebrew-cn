class Benchi < Formula
  ...
  homepage "https:github.comConduitIObenchi"
  url "https:github.comConduitIObenchiarchiverefstagsv0.4.1.tar.gz"
  sha256 "c97fc9f2e2fac7be61e9e9c2282e7ee1c9a5da78c3d6c10e40c472b1e79168ab"
  license "Apache-2.0"
  head "https:github.comConduitIObenchi.git", branch: "main"
  ...
  def install
    ...
    system "go", "build", *std_go_args(ldflags:), ".cmdbenchi"
  end

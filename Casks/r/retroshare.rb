cask "retroshare" do
  ...
  url "https:github.comRetroShareRetroSharereleasesdownloadv#{version.csv.third || version.csv.first}RetroShare-#{version.csv.first}#{"-#{version.csv.second}" if version.csv.second.present?}.dmg",
      verified: "github.comRetroShareRetroShare"
  name "RetroShare"
  ...
  livecheck do
    url "https:retroshare.ccdownloads.html"

cask "sonic-robo-blast-2-kart" do
  ...
  url "https:github.comSTJrKart-Publicreleasesdownloadv#{version}SRB2Kart-#{version}-macOS.dmg",
      verified: "github.comSTJrKart-Public"
  name "Sonic Robo Blast 2 Kart"
  desc "Classic styled kart racer, complete with beautiful courses, and wacky items"
  homepage "https:mb.srb2.orgaddonssrb2kart.2435"

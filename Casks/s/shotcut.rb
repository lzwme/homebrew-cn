cask "shotcut" do
  ...
  url "https://ghfast.top/https://github.com/mltframework/shotcut/releases/download/v#{version.csv.first}/shotcut-#{os}-#{version.csv.second || version.csv.first}.#{url_end}"
  name "Shotcut"
  desc "Video editor"

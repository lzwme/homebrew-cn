cask "synfigstudio" do
  ...
  url "https:github.comsynfigsynfigreleasesdownloadv#{version.csv.first}SynfigStudio-#{version.csv.first}-#{version.csv.second}-osx-#{version.csv.third}.dmg",
      verified: "github.comsynfigsynfig"
  name "Synfig Studio"
  ...
  # Release Notes page: https:synfig.readthedocs.ioenlatestreleases.html).
  livecheck do
    url :url

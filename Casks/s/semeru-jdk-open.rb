cask "semeru-jdk-open" do
  ...
  url "https:github.comibmruntimessemeru#{version.major}-binariesreleasesdownloadjdk-#{version.csv.first}%2B#{version.csv.second}_#{version.csv.third}ibm-semeru-open-jdk_#{arch}_mac_#{version.csv.first}_#{version.csv.second}_#{version.csv.third}.pkg",
      verified: "github.comibmruntimes"

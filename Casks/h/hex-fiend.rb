cask "hex-fiend" do
  ...
  url "https://ghfast.top/https://github.com/hexfiend/HexFiend/releases/download/v#{version}/Hex_Fiend_#{version.major_minor_patch.chomp(".0")}.dmg",
  ...
  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/hexfiend/HexFiend/master/app/appcast.xml"

cask "unraid-usb-creator" do
  ...
  url "https://ghfast.top/https://github.com/unraid/usb-creator-next/releases/download/v#{version.csv.first}-unraid.#{version.csv.second}/Unraid.USB.Creator-v#{version.csv.first}-unraid.#{version.csv.second}.dmg"

cask "dockflow" do
  ...
  url "https://ghfast.top/https://github.com/AppitStudio/dock-flow-updates/releases/download/V#{version}/DockFlow.dmg",
  ...
  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/AppitStudio/dock-flow-updates/refs/heads/main/appcast.xml"
    strategy :sparkle
  end

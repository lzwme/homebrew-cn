cask "darkmodebuddy" do
  ...
  url "https:su.darkmodebuddy.appDarkModeBuddy_v#{version.csv.first}-#{version.csv.second}.dmg",
      verified: "darkmodebuddy.app"
  name "DarkModeBuddy"
  desc "Automatically switch between light and dark modes based on ambient light sensor"
  homepage "https:github.cominsideguiDarkModeBuddy"

  livecheck do
    url "https:su.darkmodebuddy.appappcast.xml"
    strategy :sparkle
  end
  ...
  zap trash: "~LibraryPreferencescodes.rambo.DarkModeBuddy.plist"
end
cask "eddie" do
  ...
  on_mojave :or_older do
    ...
    url "https:eddie.websitedownload?platform=macos-10.9&arch=#{arch}&ui=ui&format=disk.dmg&version=#{version}"
  end
  on_catalina :or_newer do
    ...
    url "https:eddie.websitedownload?platform=macos-10.15&arch=#{arch}&ui=ui&format=disk.dmg&version=#{version}"
  end
  ...
  livecheck do
    url "https:github.comAirVPNEddie"

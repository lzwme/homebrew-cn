cask "ealeksandrov-cd-to" do
  ...
  url "https://ghfast.top/https://github.com/ealeksandrov/cdto/releases/download/#{version.dots_to_underscores}/cd_to_#{version.major_minor.dots_to_underscores}.zip"
  name "cd_to"

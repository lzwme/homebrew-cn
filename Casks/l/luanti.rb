cask "luanti" do
  ...
  url "https://ghfast.top/https://github.com/luanti-org/luanti/releases/download/#{version.csv.first}/luanti_#{version.csv.first}_macos#{version.csv.second}_#{arch}.zip"
  name "Luanti"

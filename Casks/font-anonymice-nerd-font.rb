cask "font-anonymice-nerd-font" do
  version "3.1.0"
  sha256 "e4525246a16369e4dd867ba868cd758e4b443ce0545b987a96d0a2236e20517f"

  url "https://ghproxy.com/https://github.com/ryanoasis/nerd-fonts/releases/download/v#{version}/AnonymousPro.zip"

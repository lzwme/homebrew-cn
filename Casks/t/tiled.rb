cask "tiled" do
  ...
  on_monterey :or_older do
    ...
    url "https://ghfast.top/https://github.com/mapeditor/tiled/releases/download/v#{version}/Tiled-#{version}_macOS-10.13-12.zip",
  ...
  on_ventura :or_newer do
    ...
    url "https://ghfast.top/https://github.com/mapeditor/tiled/releases/download/v#{version}/Tiled-#{version}_macOS-13+.zip",
        verified: "github.com/mapeditor/tiled/"
  end

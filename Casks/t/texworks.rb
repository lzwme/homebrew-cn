cask "texworks" do
  ...
  url "https:github.comTeXworkstexworksreleasesdownloadrelease-#{version.csv.first}TeXworks-macos11-#{version.csv.first}-#{version.csv.second}-git_#{version.csv.third}.dmg",

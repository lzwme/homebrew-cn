cask "tinypng4mac" do
  ...
  on_ventura :or_newer do
    ...
    url "https://ghfast.top/https://github.com/kyleduo/TinyPNG4Mac/releases/download/v#{version.csv.first}/Tiny-Image-Installer#{"-#{version.csv.second}" if version.csv.second}.dmg"

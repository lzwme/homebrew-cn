cask "anki" do
  ...
  on_catalina :or_older do
    ...
    url "https://ghproxy.com/https://github.com/ankitects/anki/releases/download/#{version}/anki-#{version}-mac-#{arch}-qt5.dmg",
  ...
  on_big_sur :or_newer do
    ...
    url "https://ghproxy.com/https://github.com/ankitects/anki/releases/download/#{version}/anki-#{version}-mac-#{arch}-qt6.dmg",
        verified: "github.com/ankitects/anki/"
  end

cask "netbeans" do
  ...
  url "https:github.comFriends-of-Apache-NetBeansnetbeans-installersreleasesdownloadv#{version.csv.second || version.csv.first}Apache-NetBeans-#{version.csv.first}-#{arch}.pkg",
      verified: "github.comFriends-of-Apache-NetBeansnetbeans-installers"
  name "NetBeans IDE"
  ...
  uninstall pkgutil: [
            ...
            delete:  "ApplicationsNetBeans"

  zap trash: [
    "~LibraryApplication SupportNetBeans",
    "~LibraryCachesNetBeans",
  ]
end
cask "netbeans" do
  ...
  url "https://ghfast.top/https://github.com/Friends-of-Apache-NetBeans/netbeans-installers/releases/download/#{version.csv.second}/Apache-NetBeans-#{version.csv.first}-#{version.csv.third}-#{arch}.pkg",

cask "notes-better" do
  ...
  url "https://ghfast.top/https://github.com/nuttyartist/notes/releases/download/v#{version}/Notes.#{version}.dmg",
  ...
  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/nuttyartist/notes/master/UPDATES_FOSS.json"

cask "netdownloadhelpercoapp" do
  ...
  on_mojave :or_older do
    ...
    url "https:github.comaclap-devvdhcoappreleasesdownloadv#{version}vdhcoapp-mac13-#{arch}-installer.pkg",
        verified: "github.comaclap-devvdhcoapp"
  ...
  on_catalina :or_newer do
    ...
    url "https:github.comaclap-devvdhcoappreleasesdownloadv#{version}vdhcoapp-mac-#{arch}-installer.pkg",
        verified: "github.comaclap-devvdhcoapp"
  ...
  homepage "https:www.downloadhelper.netwCoApp-Installation"

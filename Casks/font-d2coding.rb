cask "font-d2coding" do
  ...
  url "https://ghproxy.com/https://github.com/naver/d2codingfont/releases/download/VER#{version.csv.first}/D2Coding-Ver#{version.csv.first}-#{version.csv.second}.zip"
  name "D2 Coding"

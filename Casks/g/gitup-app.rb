cask "gitup-app" do
  ...
  url "https://ghfast.top/https://github.com/git-up/GitUp/releases/download/v#{version}/GitUp.zip",
  ...
  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/git-up/GitUp/master/appcasts/stable/appcast.xml"

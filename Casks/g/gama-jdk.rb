cask "gama-jdk" do
  ...
  url "https://ghfast.top/https://github.com/gama-platform/gama/releases/download/#{version.csv.first}/GAMA_#{version.csv.first}_MacOS#{arch}_with_JDK_#{version.csv.second}.dmg",

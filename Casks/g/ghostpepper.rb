cask "ghostpepper" do
  ...
  url "https://ghfast.top/https://github.com/matthartman/ghost-pepper/releases/download/v#{version}/GhostPepper.dmg"
  name "GhostPepper"
  desc "Speech-to-text and meeting transcription tool"
  homepage "https://github.com/matthartman/ghost-pepper"

  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/matthartman/ghost-pepper/main/appcast.xml"

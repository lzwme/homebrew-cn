cask "geoda" do
  ...
  url "https:github.comGeoDaCentergeodareleasesdownloadv#{version.csv.first}GeoDa#{version.csv.second || version.csv.first}-#{arch}-Installer.dmg",
      verified: "github.comGeoDaCentergeoda"
  name "GeoDa"

cask "macshot" do
  ...
  url "https://ghfast.top/https://github.com/sw33tLie/macshot/releases/download/v#{version}/MacShot.dmg"
  name "macshot"
  desc "Screenshot and screen recording tool"
  homepage "https://github.com/sw33tLie/macshot"

  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/sw33tLie/macshot/main/appcast.xml"

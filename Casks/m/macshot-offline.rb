cask "macshot-offline" do
  ...
  url "https://ghfast.top/https://github.com/sw33tLie/macshot/releases/download/v#{version}/MacShot-Offline.dmg"
  name "macshot Offline"
  desc "Screenshot and screen recording tool without upload integrations"
  homepage "https://github.com/sw33tLie/macshot"

  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/sw33tLie/macshot/main/appcast-offline.xml"

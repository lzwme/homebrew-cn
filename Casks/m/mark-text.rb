cask "mark-text" do
  ...
  on_macos do
    ...
    url "https://ghfast.top/https://github.com/marktext/marktext/releases/download/v#{version}/marktext-mac-#{arch}-#{version}.dmg"
  ...
  on_linux do
    url "https://ghfast.top/https://github.com/marktext/marktext/releases/download/v#{version}/marktext-linux-#{version}.AppImage"

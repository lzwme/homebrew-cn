cask "pd-l2ork" do
  ...
  url "https://ghproxy.com/https://github.com/agraef/purr-data/releases/download/#{version.csv.first}/Pd-l2ork-#{version.csv.first}-#{version.csv.second}-rev.#{version.csv.third}-x86_64.dmg",

cask "gpgfrontend" do
  ...
  on_big_sur do
    ...
    url "https://ghproxy.com/https://github.com/saturneric/GpgFrontend/releases/download/v#{version}/GpgFrontend-#{version}-macos-11-x86_64.dmg",
        verified: "github.com/saturneric/GpgFrontend/"
  end
  on_monterey :or_newer do
    sha256 "cd1823c287cfcf550939908938e87aafe0e481fe38edafd3aa79557085b59350"

    url "https://ghproxy.com/https://github.com/saturneric/GpgFrontend/releases/download/v#{version}/GpgFrontend-#{version}-macos-12-x86_64.dmg",
        verified: "github.com/saturneric/GpgFrontend/"
  end

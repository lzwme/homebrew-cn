cask "font-lxgw-wenkai" do
  version "1.312"
  sha256 "050d54e4cf32e81cdece7e0c8f4a93c12fd5cd9a9a98baac3ea244044e360f90"

  url "https://ghproxy.com/https://github.com/lxgw/LxgwWenKai/releases/download/v#{version}/lxgw-wenkai-v#{version}.zip"
  name "LXGW WenKai"
  name "霞鹜文楷"

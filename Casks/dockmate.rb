cask "dockmate" do
  ...
  url "https://ghproxy.com/https://raw.githubusercontent.com/w0lfschild/app_updates/master/DockMate/DockMate.#{version.csv.first}.zip",
  ...
  livecheck do
    url "https://ghproxy.com/https://raw.githubusercontent.com/w0lfschild/app_updates/master/DockMate/appcast.xml"
    strategy :sparkle
  end

cask "openbci" do
  ...
  url "https:github.comOpenBCIOpenBCI_GUIreleasesdownloadv#{version.csv.first}-#{version.csv.second}openbcigui_v#{version.csv.first}-#{version.csv.second}_macosx.dmg",

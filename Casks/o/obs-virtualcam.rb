cask "obs-virtualcam" do
  ...
  url "https:github.comjohnboilesobs-mac-virtualcamreleasesdownloadv#{version.csv.first}obs-mac-virtualcam-#{version.csv.second}-v#{version.csv.first}.pkg"
  name "OBS Virtual Camera"
  homepage "https:github.comjohnboilesobs-mac-virtualcam"

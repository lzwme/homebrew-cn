cask "kapitainsky-rclone-browser" do
  ...
  url "https://ghfast.top/https://github.com/kapitainsky/RcloneBrowser/releases/download/#{version.csv.first}/rclone-browser-#{version.csv.first}-#{version.csv.second}-macos.dmg"
  name "Rclone Browser"
  desc "GUI for rclone"

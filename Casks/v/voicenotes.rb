cask "voicenotes" do
  ...
  url "https:github.combrewdotcomvn-apps-releasereleasesdownload#{version}Voicenotes-#{version}#{arch}.dmg",
      verified: "github.combrewdotcomvn-apps-release"
  name "Voicenotes"
  ...
  zap trash: [
    "~LibraryApplication SupportVoicenotes",
    "~LibraryPreferencescom.voicenotes.app.plist",
  ]
end
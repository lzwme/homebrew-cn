cask "vibemeter" do
  ...
  url "https://ghfast.top/https://github.com/steipete/VibeMeter/releases/download/v#{version}/VibeMeter-#{version}.dmg",
  ...
  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/steipete/VibeMeter/main/appcast.xml"

cask "vimediamanager" do
  ...
  url "https://ghfast.top/https://github.com/vidalvanbergen/ViMediaManager/releases/download/v#{version.csv.first}/ViMediaManager#{"-#{version.csv.second}" if version.csv.second}.zip"
  name "ViMediaManager"

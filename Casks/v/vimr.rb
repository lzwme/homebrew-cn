cask "vimr" do
  ...
  url "https://ghfast.top/https://github.com/qvacua/vimr/releases/download/v#{version.csv.first}-#{version.csv.second}/VimR-v#{version.csv.first}.tar.bz2"
  name "VimR"
  desc "GUI for the Neovim text editor"
  homepage "https://github.com/qvacua/vimr"

  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/qvacua/vimr/refs/heads/master/appcast.xml"

cask "inkstitch" do
  ...
  on_monterey :or_older do
    ...
    url "https://ghfast.top/https://github.com/inkstitch/inkstitch/releases/download/v#{version}/inkstitch-#{version}-old-osx-x86_64.pkg",
  ...
  on_ventura :or_newer do
    ...
    url "https://ghfast.top/https://github.com/inkstitch/inkstitch/releases/download/v#{version}/inkstitch-v#{version}-osx-#{arch}.pkg",
        verified: "github.com/inkstitch/inkstitch/"

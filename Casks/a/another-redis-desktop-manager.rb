cask "another-redis-desktop-manager" do
  ...
  url "https://ghfast.top/https://github.com/qishibo/AnotherRedisDesktopManager/releases/download/v#{version}/Another-Redis-Desktop-Manager-#{os}-#{version}-#{arch}.#{url_end}"

cask "autopkgr" do
  ...
  url "https://ghfast.top/https://github.com/lindegroup/autopkgr/releases/download/v#{version}/AutoPkgr-#{version}.dmg",
  ...
  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/lindegroup/autopkgr/appcast/appcast.xml"

cask "altersend" do
  ...
  on_macos do
    ...
    url "https://ghfast.top/https://github.com/denislupookov/altersend/releases/download/v#{version}/AlterSend-#{version}#{arch}.#{os}"
  ...
  on_linux do
    ...
    url "https://ghfast.top/https://github.com/denislupookov/altersend/releases/download/v#{version}/AlterSend-#{arch}.#{os}"

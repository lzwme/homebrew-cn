cask "ananas-analytics-desktop-edition" do
  ...
  url "https:github.comananas-analyticsananas-desktopreleasesdownloadv#{version}Ananas.Analytics.Desktop.Edition-#{version}.macos.dmg",
      verified: "github.comananas-analyticsananas-desktop"

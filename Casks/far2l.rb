cask "far2l" do
  ...
  on_mojave :or_older do
    url "https://ghproxy.com/https://github.com/elfmz/far2l/releases/download/v_#{version}/far2l-#{version}-beta-MacOS-10.11.dmg"

    sha256 "475f1823652c6e59ff5fe4af448c27b6f88a8f38ac0f358a6620d8aaf5f43c99"
  end
  on_catalina :or_newer do
    url "https://ghproxy.com/https://github.com/elfmz/far2l/releases/download/v_#{version}/far2l-#{version}-beta-MacOS-10.15.dmg"

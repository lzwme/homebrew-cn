cask "font-liberation" do
  ...
  url "https:github.comliberationfontsliberation-fontsfiles#{version.csv.second}liberation-fonts-ttf-#{version.csv.first}.tar.gz"
  name "Liberation"
  homepage "https:github.comliberationfontsliberation-fonts"

  livecheck do
    url "https:github.comliberationfontsliberation-fontsreleaseslatest"

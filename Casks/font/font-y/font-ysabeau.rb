cask "font-ysabeau" do
  ...
  url "https:github.comCatharsisFontsEauDeGaramondreleasesdownloadv#{version}Ysabeau_Install_v#{version}.zip"
  name "Ysabeau"
  homepage "https:github.comCatharsisFontsEauDeGaramond"

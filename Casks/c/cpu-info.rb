cask "cpu-info" do
  ...
  url "https:github.comkamgurgulcpu-inforeleasesdownloadjvm-#{version}CPU-Info-macos-#{arch}-#{version}.dmg"
  name "CPU Info"
  desc "Provides information about device hardware and software"
  homepage "https:github.comkamgurgulcpu-info"
  ...
  zap trash: "~LibraryPreferencesCPU-Info"
end
cask "create-recovery-partition-installer" do
  ...
  url "https://ghfast.top/https://github.com/MagerValp/Create-Recovery-Partition-Installer/releases/download/v#{version}/Create.Recovery.Partition.Installer-#{version}.dmg"

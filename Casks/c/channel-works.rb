cask "channel-works" do
  ...
  url "https://ghfast.top/https://github.com/channel-io/channel-works-macos/releases/download/v#{version}/Channel.Works-darwin-universal-#{version}.zip"
  name "Channel Works"
  desc "AI Business OS for customer support, analytics, collaboration, and marketing"
  homepage "https://channel.io/"

  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/channel-io/channel-works-macos/main/desktop-releases.json"

cask "cockatrice" do
  on_mojave :or_older do
    ...
    url "https:github.comCockatriceCockatricereleasesdownload#{version.csv.second}-Release-#{version.csv.first}Cockatrice-#{version.csv.third}-#{version.csv.first}-macOS-10.14_Mojave.dmg",
  ...
  on_catalina do
    ...
    url "https:github.comCockatriceCockatricereleasesdownload#{version.csv.second}-Release-#{version.csv.first}Cockatrice-#{version.csv.third}-#{version.csv.first}-macOS-10.15_Catalina.dmg",
        verified: "github.comCockatriceCockatrice"
  end

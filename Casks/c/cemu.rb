cask "cemu" do
  ...
  on_catalina do
    ...
    url "https:github.comCE-ProgrammingCEmureleasesdownloadv#{version}CEmu-v#{version}_macOS_Qt5_intel.dmg",
        verified: "github.comCE-ProgrammingCEmu"
  end
  on_big_sur :or_newer do
    ...
    url "https:github.comCE-ProgrammingCEmureleasesdownloadv#{version}CEmu-v#{version}_macOS_Qt6_#{arch}.dmg",
        verified: "github.comCE-ProgrammingCEmu"
  end
  ...
  zap trash: [
    "~LibraryPreferencescemu-dev",
    "~LibraryPreferencescom.yourcompany.CEmu.plist",
  ]
end
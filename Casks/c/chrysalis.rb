cask "chrysalis" do
  ...
  url "https:github.comkeyboardioChrysalisreleasesdownloadv#{version}Chrysalis-#{version}-universal.dmg"
  name "Chrysalis"
  desc "Graphical configurator for Kaleidoscope-powered keyboards"
  homepage "https:github.comkeyboardioChrysalis"
  ...
  zap trash: [
    "~LibraryApplication Supportchrysalis",
    "~LibraryPreferenceskeyboardio.chrysalis.plist",
  ]
end
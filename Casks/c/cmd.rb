cask "cmd" do
  ...
  url "https://ghfast.top/https://github.com/getcmd-dev/cmd/releases/download/v#{version}/cmd.dmg",
  ...
  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/getcmd-dev/cmd/main/app/fastlane/appcast.xml"

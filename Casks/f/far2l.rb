cask "far2l" do
  ...
  on_mojave :or_older do
    ...
    url "https://ghproxy.com/https://github.com/elfmz/far2l/releases/download/v_#{version}/far2l-#{version}-beta-MacOS-10.11-x64.dmg"
  end
  on_catalina do
    sha256 "14cca152c80eed3a7161796268a0780bd794532a51a37d8e35d075b59787a336"

    url "https://ghproxy.com/https://github.com/elfmz/far2l/releases/download/v_#{version}/far2l-#{version}-beta-MacOS-10.15-x64.dmg"
  end
  on_big_sur :or_newer do
    sha256 "2fdc9d2516c2349484f52532296197f8781d2f4bd7ea4c7937799529e26857b9"

    url "https://ghproxy.com/https://github.com/elfmz/far2l/releases/download/v_#{version}/far2l-#{version}-beta-MacOS-11.2-universal.dmg"
  end

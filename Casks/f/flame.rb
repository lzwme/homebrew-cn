cask "flame" do
  ...
  url "https:github.comtominsamflametouchreleasesdownload#{version.csv.first}(#{version.csv.second})Flame.#{version.csv.first}.#{version.csv.second}.zip",
      verified: "github.comtominsamflametouch"
  name "Flame"
  desc "Rendezvous service browser for iPhone  iPod touch"
  homepage "https:movieos.orgcodeflame"

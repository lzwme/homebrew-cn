cask "flameshot" do
  ...
  on_macos do
    ...
    url "https://ghfast.top/https://github.com/flameshot-org/flameshot/releases/download/v#{version.csv.first}/Flameshot-#{version.csv.second}-macos-#{arch}.dmg"
  ...
  on_linux do
    url "https://ghfast.top/https://github.com/flameshot-org/flameshot/releases/download/v#{version.csv.first}/flameshot-v#{version.csv.second}+#{version.csv.third}-artifact-appimage-x86_64.zip"

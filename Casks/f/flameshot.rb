cask "flameshot" do
  ...
  url "https://ghfast.top/https://github.com/flameshot-org/flameshot/releases/download/v#{version.csv.first}/Flameshot-#{version.csv.second || version.csv.first}-macos-#{arch}.dmg",

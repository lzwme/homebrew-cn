cask "finetune" do
  ...
  url "https://ghfast.top/https://github.com/ronitsingh10/FineTune/releases/download/v#{version}/FineTune.dmg"
  name "FineTune"
  desc "Per-application volume mixer, equalizer, and audio router"
  homepage "https://github.com/ronitsingh10/FineTune"

  livecheck do
    url "https://ghfast.top/https://raw.githubusercontent.com/ronitsingh10/FineTune/main/appcast.xml"

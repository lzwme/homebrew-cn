cask "xit" do
  on_sequoia :or_older do
    on_big_sur :or_older do
      ...
      url "https://ghfast.top/https://github.com/Uncommon/Xit/releases/download/#{version}/Xit.zip"
    ...
    on_monterey :or_newer do
      ...
      url "https://ghfast.top/https://github.com/Uncommon/Xit/releases/download/#{version}/Xit#{arch}.#{version}.zip"
  ...
  on_tahoe :or_newer do
    ...
    url "https://ghfast.top/https://github.com/Uncommon/Xit/releases/download/#{version}/Xit.#{version}.zip"

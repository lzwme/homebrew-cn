cask "cockatrice" do
  ...
  on_big_sur :or_newer do
    ...
    url "https://ghproxy.com/https://github.com/Cockatrice/Cockatrice/releases/download/#{version.csv.second}-Release-#{version.csv.first}/Cockatrice-#{version.csv.third}-#{version.csv.first}-macOS-11.0_Big_Sur.dmg",
        verified: "github.com/Cockatrice/Cockatrice/"
  end
